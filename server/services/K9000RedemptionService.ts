...
// ₪50/wash, 5-pack ₪220 → ₪44/wash, 10-pack ₪400 → ₪40/wash). Update HERE
 ...
 * only the most recently issued one, so we settle every live 'pending' k9000 hold
 * for this member — which is exactly the set that one redeem screen produced
 * (generate-qr retires the previous holds on each rotation).
 *
