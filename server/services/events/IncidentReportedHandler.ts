import { DomainEvent, DomainEventType, IncidentReportedPayload } from '@shared/events';
import { logger } from '../../lib/logger';
import { EmailService } from '../../emailService';

export async function handleIncidentReported(event: DomainEvent<IncidentReportedPayload>): Promise<void> {
