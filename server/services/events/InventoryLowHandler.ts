import { DomainEvent, DomainEventType, InventoryLowPayload } from '@shared/events';
import { logger } from '../../lib/logger';
import { EmailService } from '../../emailService';

export async function handleInventoryLow(event: DomainEvent<InventoryLowPayload>): Promise<void> {
