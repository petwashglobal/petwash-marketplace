import { DomainEvent, DomainEventType, InventoryRefilledPayload } from '@shared/events';
import { logger } from '../../lib/logger';
import { EmailService } from '../../emailService';

export async function handleInventoryRefilled(event: DomainEvent<InventoryRefilledPayload>): Promise<void> {
