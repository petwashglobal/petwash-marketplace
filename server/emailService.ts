...
export class EmailService {
  ...
  static async sendTaxInvoice(invoice: TaxInvoice): Promise<boolean> {
    ...
    try {
      ...
      const msg = {
        ...
        subject: `חשבונית מס ${invoice.invoiceNumber} - PetWash™`,
        html: htmlContent,
  ...
  static async sendRevenueReport(
    ...
    try {
      const subject = `⁦PetWash™⁩ - ${reportType.charAt(0).toUpperCase() + reportType.slice(1)} Revenue Report - ${period}`;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="color: #666; font-size: 14px; margin-top: 30px;">
                This is an automated report generated by ⁦PetWash™⁩ Revenue Reporting System. 
                Reports are sent to: <strong>${this.REPORTS_EMAIL}</strong>
            </p>
        </div>
        
        <div class="footer">
            <p>⁦PetWash™⁩ - Premium Organic Pet Care</p>
...
<body>
  <div class="container">
    <div class="header">
      <h1>PetWash™ - דוח מע״מ אוטומטי</h1>
...
<body>
    <div class="gift-card">
        ...
        <div class="instructions">
            <p>Present this QR code at any ⁦PetWash™⁩ station to redeem your wash.</p>
      ...
      const msg = {
        to: recipientEmail,
        from: this.FROM_EMAIL,
        subject: `PetWash™ Gift Card - ${voucherCode}`,
        html: htmlContent,
        bcc: this.SUPPORT_EMAIL
      };
    ...
    try {
      ...
      const bodyHtml = `
        ...
        <p style="font-size:14px;color:#4a4a4a;line-height:1.8;
          ...
          Present this code at any PetWash™ station to redeem your wash.<br>
          הציגו קוד זה בכל תחנת PetWash™ לממש את השטיפה.
        </p>
      ...
      const htmlContent = wrapEmailShell({
        title: `Purchase Confirmation ${invoice.invoiceNumber} — PetWash™`,
        bodyHtml,
        language: 'en',
      ...
      const msg = {
        ...
        subject: `Purchase Confirmation ${invoice.invoiceNumber} - PetWash™`,
...
<head>
    <meta charset="UTF-8">
    <title>⁦PetWash™⁩ - תזכורת לטיפול</title>
    <style>
...
<body>
    ...
    <div class="section">
      ...
      const msg = {
        to: email,
        from: this.FROM_EMAIL,
        subject: `תזכורת טיפול ⁦PetWash™⁩ - ${appointmentDate} ${appointmentTime}`,
        html: this.sanitizeEmailContent(htmlContent),
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message" style="margin-top: 30px;">
                ...
                <p>תודה שאתה חלק ממשפחת ⁦PetWash™⁩!</p>
            </div>
        </div>

        <div class="footer">
            <p>⁦PetWash™⁩ | שירותי רחצה פרימיום לחיות מחמד</p>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message" style="margin-top: 30px;">
                <div class="paw-prints">🐾 🐾 🐾</div>
                <p>Thank you for being part of the ⁦PetWash™⁩ family!</p>
            </div>
        </div>

        <div class="footer">
            <p>⁦PetWash™⁩ | Premium Pet Wash Services</p>
            <p>Support@PetWash.co.il | www.petwash.co.il</p>
        </div>
    </div>
</body>
      ...
      const subject = language === 'he' 
        ? `🎉 יום הולדת שמח ${dogName || ''}! 10% הנחה מיוחדת - ⁦PetWash™⁩`
        : `🎉 Happy Birthday ${dogName || ''}! Special 10% Discount - ⁦PetWash™⁩`;
...
<head>
    ...
    <title>תזכורת חיסון - ⁦PetWash™⁩</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>⁦PetWash™⁩ | שירותי רחיצה פרימיום אורגניים</p>
            <p>Support@PetWash.co.il | www.petwash.co.il</p>
        </div>
    </div>
</body>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Vaccine Reminder - ⁦PetWash™⁩</title>
    <style>
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #f0f4f8; padding: 0; margin: 0; }
        .container { max-width: 600px; margin: 40px auto; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.1); }
        .header { background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 40px; text-align: center; color: white; }
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>⁦PetWash™⁩ | Premium Organic Pet Wash Services</p>
            <p>Support@PetWash.co.il | www.petwash.co.il</p>
        </div>
    </div>
</body>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>ברוכים הבאים ל-PetWash™</title>
  <style>
      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:#fff;box-shadow:0 2px 24px rgba(0,0,0,.06);">
        ...
        <tr><td style="padding:40px 36px;">
          ...
          <p style="font-size:16px;line-height:1.8;color:#4a4a4a;margin-bottom:32px;">
            תודה שהצטרפת ל-PetWash™ — פלטפורמת טיפוח חיות המחמד הפרימיום של ישראל.<br>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to PetWash™</title>
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    body { background:#f5f5f0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; color:#1a1a1a; }
  </style>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:#fff;box-shadow:0 2px 24px rgba(0,0,0,.06);">
        ...
        <tr><td style="padding:40px 36px;">
          ...
          <h1 style="font-size:28px;font-weight:300;color:#1a1a1a;margin-bottom:24px;line-height:1.3;">${greeting}</h1>
          <p style="font-size:16px;line-height:1.8;color:#4a4a4a;margin-bottom:32px;">
            Thank you for joining PetWash™ — Israel's premium pet care platform.<br>
      ...
      if (!subject) {
        subject = language === 'he' 
          ? `🐾 ברוכים הבאים ל-⁦PetWash™⁩ - המסע שלך מתחיל כאן!`
          : `🐾 Welcome to ⁦PetWash™⁩ - Your Journey Starts Here!`;
      }
        ...
        try {
          await db
            ...
            .set({
              ...
              englishTemplate,
              subject: { 
                he: `🐾 ברוכים הבאים ל-⁦PetWash™⁩ - המסע שלך מתחיל כאן!`,
                en: `🐾 Welcome to ⁦PetWash™⁩ - Your Journey Starts Here!`
              },
  ...
  static async sendVoucherPurchaseEmail(
    ...
    try {
      ...
      const subject = isHebrew 
        ? `🎁 שובר המתנה שלך ל-⁦PetWash™⁩ - ${codeLast4} (₪${amount})`
        : `🎁 Your ⁦PetWash™⁩ Gift Voucher - ${codeLast4} (${currency} ${amount})`;
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
  <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 60px 40px; text-align: center;">
      ...
      <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 18px;">⁦PetWash™⁩ - טיפול אורגני פרימיום לחיות מחמד</p>
    </div>
    ...
    <div style="padding: 40px; text-align: center;">
      ...
      <div style="text-align: right;">
        <div style="margin-bottom: 20px; padding: 15px; background: #f7f9fc; border-radius: 10px;">
          ...
          <p style="margin: 0; color: #333; font-size: 15px;">היכנסו לחשבון שלכם באתר ⁦PetWash™⁩</p>
        </div>
        <div style="margin-bottom: 20px; padding: 15px; background: #f7f9fc; border-radius: 10px;">
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
  <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 60px 40px; text-align: center;">
      ...
      <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 18px;">⁦PetWash™⁩ - Premium Organic Pet Care</p>
    </div>
    ...
    <div style="padding: 40px; text-align: center;">
      ...
      <div style="text-align: left;">
        <div style="margin-bottom: 20px; padding: 15px; background: #f7f9fc; border-radius: 10px;">
          <div style="color: #667eea; font-size: 24px; font-weight: 700; margin-bottom: 8px;">1️⃣</div>
          <p style="margin: 0; color: #333; font-size: 15px;">Log in to your ⁦PetWash™⁩ account</p>
        </div>
        <div style="margin-bottom: 20px; padding: 15px; background: #f7f9fc; border-radius: 10px;">
          <div style="color: #667eea; font-size: 24px; font-weight: 700; margin-bottom: 8px;">2️⃣</div>
    ...
    <div style="background: #f7f9fc; padding: 30px; text-align: center; border-top: 1px solid #e1e8ed;">
      ...
      await mailService.send({
        to: email,
        from: { email: this.FROM_EMAIL, name: 'PetWash™' },
        subject,
        html: htmlContent
      });
  ...
  <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
    ...
    <div style="background: #111827; padding: 30px; text-align: center; color: white;">
      <p style="margin: 0 0 10px 0; font-size: 14px; opacity: 0.9;">
        ⁦PetWash™⁩ Legal Compliance System
      </p>
      ...
      await mailService.send({
        to: adminEmail,
        from: { email: this.FROM_EMAIL, name: 'PetWash™ Legal' },
        subject,
        html: htmlContent
      });
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>הזמנה לצוות ⁦PetWash™⁩</title>
</head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #f3f4f6; padding: 0; margin: 0;">
    <div style="max-width: 600px; margin: 0 auto; background: white;">
        ...
        <div style="background: linear-gradient(135deg, #000000 0%, #1a1a1a 100%); padding: 40px 30px; text-align: center;">
            <img src="${PETWASH_LOGO_BASE64}" alt="⁦PetWash™⁩" style="height: 60px; margin-bottom: 15px;" />
            <h1 style="color: white; margin: 0; font-size: 24px; font-weight: 600;">הזמנה לצוות ⁦PetWash™⁩</h1>
        </div>
        ...
        <div style="padding: 40px 30px;">
            ...
            <p style="color: #4a5568; font-size: 16px; line-height: 1.8; margin-bottom: 25px;">
                הוזמנת להצטרף לצוות <strong>⁦PetWash™⁩</strong> בתפקיד:<br>
      ...
      const sent = await sendEmail(
        email,
        `הזמנה לצוות ⁦PetWash™⁩ - ${roleTitle.he}`,
        htmlContent
      );
      ...
      if (isSendGridConfigured()) {
        ...
        if (mailService) {
          await mailService.send({
            to: email,
            from: { email: this.FROM_EMAIL, name: 'PetWash™' },
            subject: `הזמנה לצוות ⁦PetWash™⁩ - ${roleTitle.he}`,
            html: htmlContent
          });
  ...
  static async sendBookingConfirmation(params: {
    ...
    try {
      ...
      const subject = isHebrew
        ? `✓ אישור הזמנה ${invoiceNumber} — PetWash™`
        : `✓ Booking Confirmed ${invoiceNumber} — PetWash™`;
  ...
  <div style="max-width:580px;margin:0 auto;padding:28px 16px 48px;">
    ...
    <div style="background:#ffffff;border-radius:0 0 16px 16px;padding:32px;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
      ...
      <div style="text-align:center;font-size:12px;color:#555;line-height:2;">
        <span style="color:#FF6B6B;font-weight:700;">PetWash™</span> &nbsp;·&nbsp; ${isHebrew ? 'מחלקת שירות ולקוחות' : 'Customer Service'}<br/>
