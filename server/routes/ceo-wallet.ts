    ...
    if (!AppleWalletService.hasValidCertificates()) {
      ...
      return res.send(`
        ...
        <head>
          ...
          <title>⁦PetWash™⁩ - CEO Business Card</title>
          <style>
            body {
        ...
        <body>
          <div class="card">
            ...
            <p><strong>Nir Hadad</strong><br>Founder & CEO<br>⁦PetWash™⁩</p>
            <div class="info">
...
router.post('/send-wallet-email', async (req, res) => {
  try {
    ...
    if (passType === 'business-card') {
      emailSubject = '🎴 Your ⁦PetWash™⁩ Digital Business Card';
      emailContent = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="header">
            ...
            <p>Founder & CEO - ⁦PetWash™⁩</p>
          </div>
          <div class="content">
            <p>Dear ${name || 'Executive Team Member'},</p>
            <p>Your premium ⁦PetWash™⁩ digital business card is ready to add to Apple Wallet.</p>
      ...
      emailSubject = '🐾 Your ⁦PetWash™⁩ VIP Loyalty Card';
      emailContent = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="header">
            ...
            <p>⁦PetWash™⁩ ${tier?.toUpperCase() || 'PLATINUM'} Member</p>
          </div>
          <div class="content">
            <p>Dear ${name || 'VIP Member'},</p>
            <p>Your ⁦PetWash™⁩ VIP loyalty card is ready to add to Apple Wallet.</p>
...
router.post('/send-launch-invitation', async (req, res) => {
  try {
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <div class="subtitle">⁦PetWash™⁩ Israel Brand Launch 2026</div>
          </div>
          ...
          <div class="section">
            ...
            <p>
              It is with immense pride and excitement that we invite you to the <strong>official launch</strong> of <strong>⁦PetWash™⁩</strong> in Israel. This milestone represents months of dedication, innovation, and unwavering commitment to revolutionizing premium pet care.
            </p>
          </div>
          ...
          <div class="section">
            ...
            <p>
              ⁦PetWash™⁩ isn't just launching a service—we're introducing a <strong>premium lifestyle brand</strong> that combines cutting-edge technology, organic excellence, and uncompromising quality. This is the culmination of our vision to provide Israel's pet owners with the finest care their beloved companions deserve.
            </p>
          </div>
          ...
          <div class="section">
            <h2>🚀 Our Mission</h2>
            <p>
              To establish ⁦PetWash™⁩ as <strong>Israel's leading premium pet care brand</strong>, setting new standards for quality, convenience, and innovation. We're not just washing pets—we're creating an experience that celebrates the bond between pets and their families.
            </p>
          </div>

          <div class="quote">
            "Excellence is not a destination; it is a continuous journey that never ends."
            <div style="margin-top: 15px; color: #667eea; font-weight: 600;">— ⁦PetWash™⁩ Vision</div>
          </div>
          ...
          <div class="footer">
            ...
            <p style="font-size: 12px; margin-top: 25px; color: #9ca3af;">
              This invitation was sent by ⁦PetWash™⁩ Management<br>
    ...
    const emailData: any = {
      ...
      from: {
        email: 'noreply@petwash.co.il',
        name: '⁦PetWash™⁩ Management'
      },
      subject: `🐾 Official Invitation: ⁦PetWash™⁩ Israel Launch - ${formattedDate}`,
      html: emailContent
    };
