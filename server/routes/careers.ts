    ...
    const demoPositions: InsertCareerPosition[] = [
      {
        ...
        fullDescription: 'As a Pet Walker at ⁦PetWash™⁩, you will provide daily exercise and companionship to dogs across Israel. You will be responsible for safe, enjoyable walks while building lasting relationships with pet owners. Our walkers use GPS tracking and real-time updates to keep owners informed.',
        fullDescriptionHe: 'כמטייל כלבים ב-⁦PetWash™⁩, תספק פעילות גופנית יומית וחברות לכלבים ברחבי ישראל. תהיה אחראי על טיולים בטוחים ומהנים תוך בניית קשרים ארוכי טווח עם בעלי חיות מחמד.',
      ...
      },
      {
        ...
        department: 'operations',
        roleType: 'supplier',
        shortDescription: 'Partner with ⁦PetWash™⁩ to supply premium organic pet care products.',
        shortDescriptionHe: 'שתף פעולה עם ⁦PetWash™⁩ לאספקת מוצרי טיפוח אורגניים פרמיום לחיות מחמד.',
