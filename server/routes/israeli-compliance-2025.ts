...
import { 
  ...
  type WithholdingTaxCalculation,
  type NationalInsuranceCalculation,
...
const redactPII = (value?: string): string | undefined => {
 ...
 */
router.post('/withholding-tax/calculate', async (req: Request, res: Response) => {
  try {
    ...
    const result = IsraeliContractorComplianceService.calculateWithholdingTax(
      grossPayment,
 ...
 */
router.post('/national-insurance/calculate', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/vat-threshold/:providerId', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/payout-obligations', async (req: Request, res: Response) => {
  try {
    ...
    const result = await IsraeliContractorComplianceService.calculatePayoutTaxObligations(
      providerId,
      grossPayoutAmount,
      providerTaxInfo
    );
 ...
 */
router.get('/summary/:providerId', async (req: Request, res: Response) => {
  try {
    const { providerId } = req.params;
