...
import { requireAdminAuth, requireAuth } from '../customAuth';
 ...
 * Admin only
 */
router.post('/add', requireAdminAuth, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/seed', requireAdminAuth, async (req: Request, res: Response) => {
  try {
