...
// REMOVED 2026-06-25 (security): dead '/cortina/inquiry' free-wash authorizer.
// Trusted the QR string's value with no auth/HMAC; only the CSRF gate kept it
// unreachable. Superseded by the secure, flag-gated routes/nayax-cortina.ts
// (verify signed pass token → atomic pre-paid debit, no card charge).
