...
function getDefaultContent(kind: ClubEmailEventKind, lang: 'he' | 'en', params: LuxuryClubEmailParams) {
  ...
  const defaults: Record<ClubEmailEventKind, Record<'he' | 'en', {
    ...
    welcome: {
      ...
      en: {
        subject: `Welcome to Pet Wash™ Prestige Club`,
    ...
    club_event: {
      he: {
        subject: `אירוע מיוחד ב-Pet Wash™ Prestige Club`,
        preheader: `אירוע בלעדי לחברי המועדון. פרטים בפנים.`,
        heroTitle: `אירוע בלעדי למועדון`,
        heroSubtitle: `הוזמנת לאירוע מיוחד בלעדי לחברי Pet Wash™ Prestige Club.`,
      ...
      en: {
        subject: `Special Event at Pet Wash™ Prestige Club`,
        preheader: `An exclusive event for club members. Details inside.`,
        heroTitle: `Exclusive Club Event`,
        heroSubtitle: `You're invited to a special event exclusive to Pet Wash™ Prestige Club members.`,
        ctaLabel: `Learn More`,
