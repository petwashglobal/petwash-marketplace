...
export function generateBackendTeamInvitation(data: BackendInvitationData): { subject: string; html: string } {
  const subject = '🚀 Join the ⁦PetWash™⁩ Backend Revolution';
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        We're absolutely <strong>thrilled</strong> to invite you to join the <strong>⁦PetWash™⁩ Backend Engineering Team</strong> — 
      ...
      <div class="highlight-box">
        ...
        <p>
          ...
          Your dedication, innovation, and passion for excellence perfectly embody the ⁦PetWash™⁩ spirit. 
    ...
    <div class="footer">
      <p class="footer-text">
        🐾 ⁦PetWash™⁩ — Where Technology Meets Unconditional Love<br>
