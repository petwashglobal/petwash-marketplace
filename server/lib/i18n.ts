...
export const emailTemplates = {
  passwordSetup: {
    subject: {
      en: 'Set up your ⁦PetWash™⁩ admin account',
      he: 'הגדר את חשבון המנהל שלך ב-⁦PetWash™⁩'
    },
    greeting: {
    ...
    body: {
      en: 'Your ⁦PetWash™⁩ admin account has been created. Click the link below to set your password and activate your account:',
      he: 'חשבון המנהל שלך ב-⁦PetWash™⁩ נוצר. לחץ על הקישור למטה כדי להגדיר את הסיסמה שלך ולהפעיל את החשבון:'
    },
    buttonText: {
    ...
    signature: {
      en: '⁦PetWash™⁩ Admin Team',
      he: 'צוות המנהלים של ⁦PetWash™⁩'
    }
  },
  passwordReset: {
    subject: {
      en: 'Reset your ⁦PetWash™⁩ password',
      he: 'אפס את הסיסמה שלך ב-⁦PetWash™⁩'
    },
    greeting: {
      en: (name: string) => `Hi ${name},`,
      he: (name: string) => `שלום ${name},`
