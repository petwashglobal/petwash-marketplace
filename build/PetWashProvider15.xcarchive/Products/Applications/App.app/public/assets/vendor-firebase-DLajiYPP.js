 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vb(n=fs()){return gb().then(e=>{if(!e)throw be.create("unsupported-browser")},e=>{throw be.create("indexed-db-unsupported")}),Rt(x(n),"messaging").getImmediate()}async function Lb(n,e){return n=x(n),nm(n,e)}function Mb(n,e){return n=x(n),_b(n,e)}mb();export{Ud as A,Dd as B,Sd as C,KI as D,dE as E,lt as F,ht as G,Ob as H,Db as I,kS as J,uI as K,Pa as L,oI as M,dI as N,Pr as O,an as P,Vb as Q,jI as R,Cb as S,ee as T,Lb as U,Mb as V,Pb as W,Ib as X,kb as a,ZI as b,Tb as c,_s as d,Ky as e,My as f,bb as g,eA as h,Sb as i,QE as j,Uy as k,Fy as l,$y as m,qy as n,Rb as o,cd as p,vb as q,wb as r,oE as s,yb as t,Jy as u,By as v,Ab as w,a_ as x,fs as y,Nb as z};
