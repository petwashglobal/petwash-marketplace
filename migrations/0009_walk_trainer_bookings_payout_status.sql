...
-- Vocabulary: pending | pending_transfer | paid_out | failed
-- pending_transfer: walk/session completed, payout queued for manual release until Nayax transfer integration is live
