...
const PLATFORM_CONFIG: PlatformConfig[] = [
  ...
  },
  {
    id: "hub",
    shortName: "Wash Hub",
    fullName: "⁦PetWash™⁩ Hub Operators",
...
const PROFILES: ContractorProfile[] = [
  ...
  // Wash Hub operators
  {
    ...
    mainService: "Natural shampoos, shade, lockers and integrated loyalty.",
    location: "Ramat Gan National Park, Israel",
    rating: 4.93,
    reviews: 112,
    priceFrom: "From $18 per wash",
    heroLabel: "Flagship hub",
    badges: ["Natural products", "Shade", "Self service"],
  ...
  // Enterprise partners
  {
    ...
    name: "⁦PetWash™⁩ Tel Aviv Site Review",
    title: "Location partner candidate",
    mainService: "Site, supply, support, and operating evidence under review.",
    location: "Tel Aviv, Israel",
    rating: 4.98,
    reviews: 17,
  ...
  },
  {
    id: "ent2",
    platformId: "enterprise",
    name: "Regional Partner Review",
    title: "Operations partner candidate",
    mainService: "Multi-site operation concept pending legal, accountant, and owner approval.",
    location: "Manual review",
    rating: 5,
    reviews: 9,
    priceFrom: "Enterprise terms",
    heroLabel: "Manual review",
    badges: ["Legal review", "Finance review", "Data agreements"],
    specialties: ["Approved sites", "Brand compliance", "Support SLA"],
        ...
        <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-slate-600">
              ⁦PetWash™⁩ Luxury Marketplace, designed for 2026. All profiles
