...
const dict: Record<Lang, Record<string, string>> = {
  he: {
    ...
    tiers_sub: "רמות יוקרה בלעדיות של PetWash. לחצו על כל דרגה כדי לראות פירוט מלא, הטבות ומה נפתח.",
    ...
    progress_sub: "רואים בדיוק איפה אתם ומה חסר לדרגה הבאה. כל נתון אמיתי מגיע מחשבון מאומת בלבד.",
  ...
  en: {
    ...
    tiers_title: "The Prestige Collection",
    tiers_sub: "Exclusive PetWash luxury tiers. Click each tier for full details, perks, and unlocks.",
    ...
    progress_sub: "See exactly where you are and what's left for the next tier. Real status is shown only from a verified member account.",
