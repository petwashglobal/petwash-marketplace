...
export default function OwnerDashboard() {
  ...
  const statCards = [
    { label: t('sitterHub.confirmed'), value: upcomingBookings.length, icon: CheckCircle2, gradient: 'from-[#D4AF37] to-rose-500', shadow: 'shadow-[#D4AF37]/20' },
    { label: t('sitterHub.totalSpent'), value: `₪${totalSpent.toFixed(0)}`, icon: DollarSign, gradient: 'from-[#D4AF37] to-[#B8932F]', shadow: 'shadow-[#D4AF37]/20' },
    { label: t('sitterHub.myPets'), value: pets.length, icon: PawPrint, gradient: 'from-rose-400 to-[#B8932F]', shadow: 'shadow-rose-100' },
    { label: t('sitterHub.completed'), value: pastBookings.length, icon: Calendar, gradient: 'from-[#D4AF37] to-[#B8932F]', shadow: 'shadow-[#D4AF37]/20' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 pt-10 pb-12 md:pt-14 md:pb-16">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <Link href="/sitter-suite/browse">
              <Button 
                className="group relative bg-gradient-to-r from-[#D4AF37] via-[#C9A536] to-rose-500 hover:from-[#D4AF37] hover:via-[#C9A536] hover:to-rose-600 text-white px-8 py-6 text-base font-bold rounded-2xl shadow-xl shadow-[#D4AF37]/20 transition-all duration-300 hover:shadow-2xl hover:shadow-[#D4AF37]/20 hover:-translate-y-1 active:translate-y-0"
      ...
      <div className="h-px bg-gradient-to-r from-transparent via-[#C9A536] to-transparent" />
          ...
          <TabsList className="bg-white border border-gray-200 rounded-2xl p-1.5 grid w-full grid-cols-5 lg:w-auto lg:inline-grid shadow-sm">
            {[
              ...
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="rounded-xl text-sm data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#D4AF37] data-[state=active]:to-[#B8932F] data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-[#D4AF37]/20 text-gray-500 font-semibold transition-all duration-200"
              >
              ...
              <div className="bg-white rounded-3xl border border-amber-200/80 overflow-hidden shadow-sm">
                ...
                <div className="p-5 space-y-3">
                  {pendingBookings.slice(0, 3).map((booking) => (
                    <div key={booking.id} className="flex items-center justify-between p-4 bg-white border border-gray-100 rounded-2xl hover:border-[#D4AF37]/20 hover:shadow-sm transition-all group">
                      <div className="flex items-center gap-4">
                        <Avatar className="w-12 h-12 ring-2 ring-[#D4AF37] ring-offset-2">
                          <AvatarImage src={booking.sitterPhoto || undefined} />
                          <AvatarFallback className="bg-gradient-to-br from-[#D4AF37] to-[#B8932F] text-white font-bold text-sm">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
              <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                <h2 className="text-lg font-bold text-gray-900 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#D4AF37] to-[#B8932F] flex items-center justify-center shadow-md shadow-[#D4AF37]/20">
                ...
                {upcomingBookings.length === 0 ? (
                  <div className="text-center py-16">
                    <div className="relative mx-auto w-24 h-24 mb-6">
                      ...
                      <div className="relative w-24 h-24 rounded-full bg-white flex items-center justify-center border border-gray-200">
                        <PawPrint className="w-10 h-10 text-[#D4AF37]" />
                      </div>
                    </div>
                    ...
                    <Link href="/sitter-suite/browse">
                      <Button className="bg-gradient-to-r from-[#D4AF37] to-[#B8932F] hover:from-[#D4AF37] hover:to-[#B8932F] text-white rounded-2xl px-8 py-3 font-bold shadow-xl shadow-[#D4AF37]/20 transition-all hover:shadow-2xl hover:-translate-y-0.5">
                  ...
                  <div className="space-y-4">
                    {upcomingBookings.map((booking) => (
                      <div key={booking.id} className="group bg-white border border-gray-100 rounded-2xl p-6 hover:border-[#D4AF37]/20 hover:shadow-lg hover:shadow-[#D4AF37]/20 transition-all duration-300">
                        <div className="flex flex-col md:flex-row gap-5">
                          <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-[#D4AF37] via-[#C9A536] to-rose-500 p-[3px] shrink-0 shadow-lg shadow-[#D4AF37]/20 group-hover:shadow-xl transition-shadow">
                            <div className="w-full h-full rounded-[13px] bg-white flex items-center justify-center overflow-hidden">
                              {booking.sitterPhoto ? (
                                ...
                                <span className="text-2xl font-extrabold bg-gradient-to-br from-[#D4AF37] to-[#B8932F] bg-clip-text text-transparent">
                                  {booking.sitterName.charAt(0)}
                                </span>
                              )}
                            </div>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
              ...
              <div className="p-5 space-y-3">
                {bookings.map((booking) => (
                  <div key={booking.id} className="bg-white border border-gray-100 rounded-2xl p-4 md:p-5 hover:border-[#D4AF37]/20 hover:shadow-sm transition-all">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <Avatar className="w-11 h-11 ring-2 ring-[#D4AF37] ring-offset-1">
                          <AvatarImage src={booking.sitterPhoto || undefined} />
                          <AvatarFallback className="bg-gradient-to-br from-[#D4AF37] to-[#B8932F] text-white font-bold text-sm">
                            {booking.sitterName.charAt(0)}
                          </AvatarFallback>
                        ...
                        <div className="flex items-center gap-2 justify-end">
                          ...
                          {booking.status === 'completed' && (
                            <Button
                              size="sm"
                              variant="outline"
                              className="gap-1.5 rounded-xl border-[#D4AF37]/20 text-[#D4AF37] hover:bg-[#D4AF37]/10 font-semibold text-xs"
                ...
                {bookings.length === 0 && (
                  <div className="text-center py-16">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/10 flex items-center justify-center mx-auto mb-5 border border-[#D4AF37]/20">
                      <Calendar className="w-9 h-9 text-[#D4AF37]" />
                    </div>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {pets.map((pet) => (
                    <div key={pet.id} className="group bg-white border border-gray-100 rounded-2xl p-6 text-center hover:border-[#D4AF37]/20 hover:shadow-lg hover:shadow-[#D4AF37]/20 transition-all duration-300">
                      <div className="relative mx-auto w-24 h-24 mb-5">
                        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/10 opacity-0 group-hover:opacity-40 transition-opacity blur-md" />
                        <Avatar className="relative w-24 h-24 ring-4 ring-[#D4AF37] group-hover:ring-[#D4AF37] transition-all">
                          <AvatarImage src={pet.photoUrl || undefined} />
                          <AvatarFallback className="bg-gradient-to-br from-[#D4AF37] via-[#C9A536] to-rose-500 text-white">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
              ...
              <div className="p-5 space-y-3">
                {payments.map((payment) => (
                  <div key={payment.id} className="flex items-center justify-between p-4 bg-white border border-gray-100 rounded-2xl hover:border-[#D4AF37]/20 hover:shadow-sm transition-all">
                    <div className="flex items-center gap-4">
                ...
                {payments.length === 0 && (
                  <div className="text-center py-16">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/10 flex items-center justify-center mx-auto mb-5 border border-[#D4AF37]/20">
                      <CreditCard className="w-9 h-9 text-[#D4AF37]" />
                    </div>
