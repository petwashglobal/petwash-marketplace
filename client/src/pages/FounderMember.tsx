      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 luxury-animate-fade-in luxury-delay-1">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="luxury-heading-lg luxury-text-gradient">⁦PetWash™⁩ Founder Member</h1>
          </div>
        ...
        <div className="text-center mt-8 luxury-animate-fade-in luxury-delay-3">
          <p className="luxury-text-body">Thank you for being the foundation of ⁦PetWash™⁩</p>
