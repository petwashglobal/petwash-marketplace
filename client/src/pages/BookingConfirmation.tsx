...
/* ── i18n ─────────────────────────────────────────────────────────────── */
// k9000_wash is deliberately absent here: its Hebrew and English lines say
// "your VEHICLE will be washed" and talk about vehicle access — wrong copy for
// a dog wash. Rather than translate a mistake into two more languages, those
// four lines fall back to English until the correct wording is written.
const IMPORTANT_INFO_AR: Record<string, string[]> = {
  pet_sitting: [
    'مدة الرعاية محدودة. يرجى تجهيز حيوانك للاستلام في الوقت المحدد.',
    'جهّز الطعام والأوعية والأدوية والفراش قرب المدخل.',
    'سيتواصل معك مقدّم الرعاية قبل الوصول بساعة.',
    'في الحالات الطارئة، دعم PetWash™‎ متاح على مدار الساعة.',
  ],
  daycare: [
    'ساعات الرعاية النهارية ثابتة. يرجى استلام حيوانك في الوقت المحدد.',
    'جهّز الطعام والأوعية والأدوية والفراش قرب المدخل.',
    'سيتواصل معك مقدّم الرعاية قبل الوصول بساعة.',
    'في الحالات الطارئة، دعم PetWash™‎ متاح على مدار الساعة.',
  ],
  dog_walking: [
    'سيصل المرافق إلى العنوان المتفق عليه في الوقت المحدد تمامًا.',
    'تتبّع GPS مباشر متاح في شاشة \\"تتبّع النزهة\\" فور بدء النزهة.',
    'في الطقس القاسي قد يتغيّر المسار — وسيتم إبلاغك.',
    'أي حادث يُبلَّغ عنه فورًا ويُوثَّق وفق القانون.',
  ],
  grooming: [
    'يرجى إحضار سجل تطعيمات محدّث (إلزامي).',
    'ستصلك رسالة للاستلام — يرجى الحضور خلال ساعة.',
    'الحيوانات ذات البشرة الحساسة — يرجى ذكر ذلك في تعليمات المالك.',
    'الإلغاء قبل أقل من 24 ساعة — رسوم 50%.',
  ],
  pet_taxi: [
    'يرجى الاستعداد مع حيوانك داخل قفص النقل عند المدخل في الوقت المحدد.',
    'سيتواصل معك السائق قبل الوصول بـ 10 دقائق.',
    'للحيوانات القلقة، يُنصح بتغطية القفص أثناء الرحلة.',
    'الإلغاء قبل أقل من ساعتين — رسوم كاملة.',
  ],
  training: [
    'يرجى الحضور بكلب جائع قليلًا — يساعد على التركيز.',
    'تعزيز إيجابي فقط — بدون أدوات عقاب.',
    'الالتزام بالسلسلة الكاملة مهم للنتائج.',
    'تدرّب بين الجلسات على ما تعلّمته — المالك المتدرّب ينجح.',
  ],
};
const IMPORTANT_INFO_RU: Record<string, string[]> = {
  pet_sitting: [
    'Время присмотра ограничено. Подготовьте питомца к передаче вовремя.',
    'Приготовьте корм, миски, лекарства и подстилку у входа.',
    'Исполнитель свяжется с вами за час до прибытия.',
    'В экстренном случае поддержка PetWash™‎ доступна круглосуточно.',
  ],
  daycare: [
    'Часы дневного присмотра фиксированы. Заберите питомца вовремя.',
    'Приготовьте корм, миски, лекарства и подстилку у входа.',
    'Исполнитель свяжется с вами за час до прибытия.',
    'В экстренном случае поддержка PetWash™‎ доступна круглосуточно.',
  ],
  dog_walking: [
    'Выгульщик придёт по согласованному адресу точно вовремя.',
    'Отслеживание по GPS доступно на экране прогулки, как только она начнётся.',
    'В экстремальную погоду маршрут может измениться — вам сообщат.',
    'О любом происшествии сообщат немедленно и задокументируют по закону.',
  ],
  grooming: [
    'Возьмите актуальный паспорт прививок (обязательно).',
    'Вы получите уведомление — заберите питомца в течение часа.',
    'Чувствительная кожа — укажите это в инструкциях владельца.',
    'Отмена менее чем за 24 часа — сбор 50%.',
  ],
  pet_taxi: [
    'Ждите у входа с питомцем в переноске точно ко времени.',
    'Водитель свяжется за 10 минут до прибытия.',
    'Для тревожных питомцев переноску в дороге лучше накрыть.',
    'Отмена менее чем за 2 часа — полная оплата.',
  ],
  training: [
    'Приходите со слегка голодной собакой — легче удерживать внимание.',
    'Только положительное подкрепление — без наказывающих средств.',
    'Для результата важно пройти весь курс.',
    'Тренируйтесь между занятиями — так закрепляется результат.',
  ],
};
const labels = {
  he: {
  ...
  ar: {
    ...
    payoutNote:        'سيتم تحويل مستحقات مقدّم الخدمة خلال 72 ساعة',
    sendSMS:           'إرسال رسالة نصية',
    sendEmail:         'إرسال الإيصال بالبريد',
    smsSent:           'تم إرسال الرسالة النصية بنجاح',
    emailSent:         'تم إرسال الإيصال بالبريد الإلكتروني',
    back:              'كل الحجوزات',
    escrow:            'حفظ آمن للأموال 72 ساعة',
    thankYou:          'شكرًا لاختيارك PetWash™‎! نتطلع لرؤيتك مرة أخرى 😊',
    paymentSuccessTitle: 'تم استلام الدفع · الحجز مؤكَّد',
    paymentSuccessSub: 'تُحفظ الأموال بشكل آمن حتى اكتمال الخدمة.',
    paymentFailedTitle: 'تعذّرت معالجة الدفع',
    paymentFailedSub:  'لم يتم خصم أي مبلغ. يمكنك المحاولة مرة أخرى أو التواصل مع الدعم.',
    paymentBannerDismiss: 'إخفاء',
    phoneLabel:        'رقم الهاتف',
    emailLabel:        'عنوان البريد الإلكتروني',
    phonePlaceholder:  '+972...',
    emailPlaceholder:  'you@email.com',
    confirmAndNotify:  'تأكيد وإرسال الإشعارات',
    confirming:        'جارٍ التأكيد...',
    rating:            'قيّم الخدمة',
    review:            'مراجعة (اختياري)',
    endOfStayTitle:    'اكتمل حجزك — أليس كذلك؟',
    endOfStayLead:     'وضع مقدّم الخدمة علامة على انتهاء الخدمة. أكّد لإنهاء الحجز — سيُحوَّل المبلغ إلى مقدّم الخدمة بعد تأكيدك.',
    endOfStayNext:     'ماذا يحدث بعد ذلك؟',
    endOfStayStep1:    'أكّد انتهاء الخدمة أدناه.',
    endOfStayStep2:    'سيُطلب منك تقييم بالنجوم ومراجعة قصيرة — فهي تساعد أصحاب الحيوانات الآخرين على الاختيار.',
    awaitingReport:    'بانتظار تأكيدك',
    chatNowTitle:      'أكّد مقدّم الخدمة! هل أنت مستعد للبدء؟',
    chatNowSub:        'تحدّث مع مقدّم الخدمة، ونسّق التفاصيل، واستعد للزيارة.',
    chatNowBtn:        'الدردشة الآن',
    rebookTitle:       'احجز مرة أخرى',
    rebookWith:        'احجز مرة أخرى مع',
    rebookSub:         'نفس الحيوانات، نفس الخدمة — بلمسة واحدة',
    rebookBtn:         'احجز مرة أخرى',
    viewAllBookings:   'حجوزاتي',
    declinedTitle:     'تم رفض الطلب',
    cancelledTitle:    'تم إلغاء الحجز',
    findAnotherProvider: 'ابحث عن مقدّم خدمة آخر',
    findAnotherSub:    'لدينا مقدّمو خدمة آخرون جاهزون للمساعدة',
    declinedReason:    'السبب',
    cancelledBy:       'أُلغي بواسطة',
    byProvider:        'مقدّم الخدمة',
    byCustomer:        'العميل',
    refund:            'استرداد',
    loyaltyRedeemed:   'رصيد مستخدَم',
    creditsEarned:     'رصيد مكتسب',
    importantInfo:     'معلومات مهمة',
    greetingLine:      'تم تسجيل حجزك بنجاح.',
    dear:              'عزيزي/عزيزتي',
    modify:            'تعديل الحجز',
    cancel:            'إلغاء الحجز',
    share:             'مشاركة',
    addCalendar:       'التقويم',
    messageProvider:   'رسالة',
    callProvider:      'اتصال',
    navigate:          'التنقّل',
    cancelConfirm:     'إلغاء هذا الحجز؟',
    cancelYes:         'نعم، ألغِ',
    cancelNo:          'لا، احتفظ به',
    cancelling:        'جارٍ الإلغاء...',
    cancelSuccess:     'تم إلغاء الحجز',
    provider:          'مقدّم الخدمة',
    petCount:          'الحيوانات الأليفة',
    date:              'التاريخ',
    time:              'الوقت',
    paymentStartFailed: 'تعذّر بدء الدفع. حاول مرة أخرى.',
    heroBookingConfirmed: 'تم تأكيد الحجز',
    heroThankYouTemplate: 'شكرًا {name}، تم تأكيد حجزك وأرسلنا الإيصال إلى {email}.',
    heroThankYouNoEmail: 'شكرًا {name}، تم تأكيد حجزك.',
    heroOrderReference: 'مرجع الطلب',
    heroOrderSummary:  'ملخّص الطلب',
    heroTotal:         'الإجمالي',
    heroLocation:      'الموقع',
    heroAddToApple:    'أضف إلى Apple Wallet',
    heroAddToGoogle:   'أضف إلى Google Wallet',
    heroWalletLoading: 'جارٍ التجهيز…',
    heroWalletFailed:  'تعذّر تجهيز بطاقة المحفظة. حاول مرة أخرى.',
  },
  ru: {
    title:             'Подтверждение брони',
    bothConfirmed:     'Бронь оформлена!',
    bookingId:         'Номер брони',
    service:           'Услуга',
    dates:             'Даты',
    pets:              'Питомцы',
    subtotal:          'Подытог',
    fee:               'Сервисный сбор (15%)',
    total:             'Итого',
    status:            'Статус',
    confirmed:         'Подтверждено',
    completed:         'Завершено',
    reviewed:          'Отзыв оставлен',
    payoutNote:        'Выплата исполнителю будет переведена в течение 72 часов',
    sendSMS:           'Отправить SMS',
    sendEmail:         'Отправить чек на email',
    smsSent:           'SMS отправлено',
    emailSent:         'Чек отправлен на email',
    back:              'Все брони',
    escrow:            'Безопасное хранение средств 72 часа',
    thankYou:          'Спасибо, что выбрали PetWash™‎! Ждём вас снова 😊',
    paymentSuccessTitle: 'Платёж получен · бронь подтверждена',
    paymentSuccessSub: 'Деньги хранятся безопасно до завершения услуги.',
    paymentFailedTitle: 'Не удалось обработать платёж',
    paymentFailedSub:  'Списания не было. Попробуйте ещё раз или обратитесь в поддержку.',
    paymentBannerDismiss: 'Скрыть',
    phoneLabel:        'Номер телефона',
    emailLabel:        'Адрес email',
    phonePlaceholder:  '+972...',
    emailPlaceholder:  'you@email.com',
    confirmAndNotify:  'Подтвердить и отправить уведомления',
    confirming:        'Подтверждаем...',
    rating:            'Оцените услугу',
    review:            'Отзыв (необязательно)',
    endOfStayTitle:    'Ваша бронь завершена — верно?',
    endOfStayLead:     'Исполнитель отметил услугу как выполненную. Подтвердите, чтобы завершить бронь — деньги будут переведены исполнителю после вашего подтверждения.',
    endOfStayNext:     'Что дальше?',
    endOfStayStep1:    'Подтвердите окончание услуги ниже.',
    endOfStayStep2:    'Мы попросим оценку и короткий отзыв — это помогает другим владельцам выбрать.',
    awaitingReport:    'Ожидает вашего подтверждения',
    chatNowTitle:      'Исполнитель подтвердил! Готовы начать?',
    chatNowSub:        'Напишите исполнителю, согласуйте детали и подготовьтесь к визиту.',
    chatNowBtn:        'Открыть чат',
    rebookTitle:       'Забронировать снова',
    rebookWith:        'Забронировать снова у',
    rebookSub:         'Те же питомцы, та же услуга — в одно касание',
    rebookBtn:         'Забронировать снова',
    viewAllBookings:   'Мои брони',
    declinedTitle:     'Заявка отклонена',
    cancelledTitle:    'Бронь отменена',
    findAnotherProvider: 'Найти другого исполнителя',
    findAnotherSub:    'У нас есть другие исполнители, готовые помочь',
    declinedReason:    'Причина',
    cancelledBy:       'Отменил',
    byProvider:        'Исполнитель',
    byCustomer:        'Клиент',
    refund:            'Возврат',
    loyaltyRedeemed:   'Списано баллов',
    creditsEarned:     'Начислено баллов',
    importantInfo:     'Важная информация',
    greetingLine:      'Ваша бронь успешно оформлена.',
    dear:              'Уважаемый(ая)',
    modify:            'Изменить бронь',
    cancel:            'Отменить бронь',
    share:             'Поделиться',
    addCalendar:       'Календарь',
    messageProvider:   'Сообщение',
    ...
    heroBookingConfirmed: 'Бронь подтверждена',
    heroThankYouTemplate: 'Спасибо, {name}, ваша бронь подтверждена, чек отправлен на {email}.',
    heroThankYouNoEmail: 'Спасибо, {name}, ваша бронь подтверждена.',
    heroOrderReference: 'Номер заказа',
    heroOrderSummary:  'Состав заказа',
    heroTotal:         'Итого',
    heroLocation:      'Адрес',
    heroAddToApple:    'Добавить в Apple Wallet',
    heroAddToGoogle:   'Добавить в Google Wallet',
    heroWalletLoading: 'Готовим…',
    heroWalletFailed:  'Не удалось подготовить карту для кошелька. Попробуйте ещё раз.',
  },
};
...
export default function BookingConfirmation() {
  ...
  // 2026-09-17: was he/en only, so Arabic and Russian speakers — together about
  // a third of Israel — read this page in English after paying. Arabic is
  // right-to-left like Hebrew, so isRTL follows it too.
  const t              = labels[(language === 'he' || language === 'ar' || language === 'ru') ? language : 'en'];
  const isRTL          = language === 'he' || language === 'ar';
  const importantInfo  = language === 'he' ? IMPORTANT_INFO_HE
    : language === 'ar' ? { ...IMPORTANT_INFO_EN, ...IMPORTANT_INFO_AR }
    : language === 'ru' ? { ...IMPORTANT_INFO_EN, ...IMPORTANT_INFO_RU }
    : IMPORTANT_INFO_EN;
