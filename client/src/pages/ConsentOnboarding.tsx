...
export default function ConsentOnboarding({ language = 'he' }: ConsentOnboardingProps) {
  ...
  const text = {
    he: {
      ...
      period: ' שלנו.',
      marketing: 'אני מסכים לקבל חומרי שיווק מ-PetWash™',
      agree: 'הסכם והמשך',
    ...
    en: {
      ...
      period: '.',
      marketing: 'I consent to PetWash™ sending me marketing material.',
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-sm">
        <div className="relative mb-10">
          ...
          <div
            ...
            style={{ backgroundColor: '#ffffff', border: '1.5px solid rgba(217, 184, 76,0.25)', borderRadius: '50%' }}
          >
            <div
              className="w-36 h-36 rounded-full flex items-center justify-center"
              style={{ backgroundColor: '#D9B84C' }}
            >
        ...
        <label className="flex items-start gap-3 cursor-pointer group">
          <div className="relative mt-0.5 flex-shrink-0">
            ...
            <div
              ...
              style={{
                borderColor: marketingConsent ? '#D9B84C' : '#d1d5db',
                backgroundColor: marketingConsent ? '#D9B84C' : 'white',
              }}
            >
              {marketingConsent && (
