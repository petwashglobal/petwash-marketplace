      ...
      <div className="max-w-3xl mx-auto px-4 pb-12">
          ...
          <>
            ...
            <div className="mb-6 luxury-glass-card luxury-shadow-xl luxury-hover-glow luxury-stagger-item p-6">
              ...
              <div className="mt-4 luxury-text-small leading-relaxed opacity-80">
                ...
                זיכויי הארנק יישמרו עם אישור המאמן/ת, ואת היתרה משלמים בכרטיס אשראי בדף מאובטח של חברת הסליקה.
              </div>
            </div>
        ...
        {step === "summary" && (
          <>
            ...
            {/* What is actually collected (2026-09-18). Academy has a card rail
                now: the wallet part is taken when the trainer confirms, and the
                rest is paid on the clearing company's page — the session is
                marked paid only after that payment is verified. */}
            <div
            ...
            >
              {appliedCredits && appliedCredits.totalCreditsAppliedCents > 0 ? (
                <>
                  ...
                  {' '}את היתרה (₪{Math.max(0, pricing.totalCharged - appliedCredits.totalCreditsAppliedCents / 100).toFixed(2)}) תשלם/י בכרטיס אשראי בדף מאובטח, ואז ההזמנה מסומנת כשולמה.
                </>
              ) : (
                <>לא מחויבים עכשיו. לאחר אישור המאמן/ת תקבל/י קישור לתשלום מאובטח בכרטיס אשראי (₪{pricing.totalCharged.toFixed(2)}).</>
              )}
            </div>
          ...
          <div className="py-12 luxury-fade-in">
            <div className="text-center mb-6">
              ...
              <p className="luxury-text-body max-w-md mx-auto mb-2">
                המאמן/ת יקבל/תקבל את פרטי ההזמנה כעת. לאחר האישור: זיכויי ארנק (אם נוצלו) ייגבו, ואת היתרה תשלם/י בכרטיס אשראי בדף מאובטח.
              </p>
