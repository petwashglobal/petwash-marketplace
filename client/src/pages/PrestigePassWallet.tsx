...
function BalanceRow({ icon, label, value, color }: { icon: React.ReactNode; label: string; value: string; color?: string }) {
  return (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 0', borderBottom:'1px solid rgba(217, 184, 76,0.08)' }}>
      <div style={{ display:'flex', alignItems:'center', gap:'12px' }}>
        <div style={{ width:'36px', height:'36px', borderRadius:'10px', background:'rgba(217, 184, 76,0.08)', display:'flex', alignItems:'center', justifyContent:'center', color: color || '#D9B84C' }}>
          {icon}
        </div>
...
function PrivilegeHeroSection({ wallet, walletData, he }: { wallet: WalletData; walletData: any; he: boolean }) {
  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      {/* Gold top bar */}
      <div style={{ height: '2px', background: 'linear-gradient(90deg,#D9B84C,#f0d060,#D9B84C,#D9B84C)' }} />
      ...
      <div style={{ padding: '16px 20px 20px', textAlign: 'center', background: '#FFFFFF' }}>
        ...
        <h1 style={{ color:'#1A1A1A', fontSize:'1.15rem', fontWeight:800, letterSpacing:'-0.01em', margin:'0 0 4px' }}>
          PetWash <span style={{ color:'#0a0a0a' }}>Privilege</span>
        </h1>
        ...
        <div style={{ display:'flex', justifyContent:'center', marginTop:'6px' }}>
          <div style={{ background:'linear-gradient(90deg,#D9B84C,#f0d060,#D9B84C,#D9B84C)', padding:'4px 20px', borderRadius:'100px' }}>
      ...
      {/* Member ID row */}
      <div style={{ padding:'0 20px 24px', display:'flex', justifyContent:'space-between', borderBottom:'1px solid rgba(217, 184, 76,0.12)' }}>
        <div>
...
function BenefitsSection({ he, tier }: { he: boolean; tier: string }) {
  ...
  const benefits = [
    ...
    {
      icon: <Star size={20} color="#D9B84C" />,
      bg: 'rgba(217, 184, 76,0.08)',
  ...
  return (
    <div style={{ padding: '24px 20px 0', background: '#FFFFFF' }}>
      ...
      <div style={{ marginTop:'12px', padding:'10px 14px', background:'rgba(217, 184, 76,0.06)', borderRadius:'12px', border:'1px solid rgba(217, 184, 76,0.2)' }}>
        <p style={{ margin:0, fontSize:'0.7rem', color:'#7A7068', lineHeight:1.5 }}>
          <strong style={{ color:'#B8860B' }}>PetWash Privilege </strong>
          {he
...
function DivisionActivitySection({ he }: { he: boolean }) {
  ...
  return (
    <div style={{ padding: '24px 20px 0', background: '#FFFFFF' }}>
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              padding:'6px 14px',
              borderRadius:'100px',
              border: activeTab === t.key ? '2px solid #D9B84C' : '2px solid rgba(217, 184, 76,0.2)',
              background: activeTab === t.key ? 'rgba(217, 184, 76,0.08)' : '#FFFFFF',
              color: activeTab === t.key ? '#B8860B' : '#7A7068',
      ...
      {/* Entries */}
      <div style={{ background:'#FFFFFF', border:'1.5px solid rgba(217, 184, 76,0.15)', borderRadius:'16px', overflow:'hidden' }}>
        {isLoading ? (
          ...
          <div style={{ padding:'24px', textAlign:'center' }}>
            <Activity size={32} color="rgba(217, 184, 76,0.3)" style={{ margin:'0 auto 8px' }} />
          ...
          entries.map((entry, i) => {
            ...
            return (
              <div key={entry.entryId} style={{
                ...
                borderBottom: isLast ? 'none' : '1px solid rgba(217, 184, 76,0.08)',
              }}>
                <div style={{
...
function WalletBalanceSection({ balances, he }: { balances: WalletData['balances']; he: boolean }) {
  ...
  return (
    <div style={{ padding:'24px 20px 0', background:'#FFFFFF' }}>
      <div style={{ marginBottom:'14px', display:'flex', alignItems:'center', gap:'8px' }}>
        <TrendingUp size={15} color="#D9B84C" />
        <h2 style={{ fontSize:'0.78rem', fontWeight:700, color:'#7A7068', letterSpacing:'0.12em', textTransform:'uppercase', margin:0 }}>
      ...
      {/* Bucket breakdown */}
      <div style={{ background:'#FFFFFF', border:'1.5px solid rgba(217, 184, 76,0.2)', borderRadius:'16px', padding:'4px 16px' }}>
        <BalanceRow icon={<Wallet size={16} />}    label={he ? 'ארנק מזומן' : 'Cash Wallet'}      value={fmt(balances.cashWalletCents)}        color="#1A1A1A" />
        <BalanceRow icon={<Gift size={16} />}       label={he ? 'eGift' : 'eGift Balance'}          value={fmt(balances.egiftBalanceCents)}       color="#D9B84C" />
...
function DigitalCardSection({
  ...
  return (
    <div style={{ padding: '24px 20px 0', background: '#FFFFFF' }}>
      {/* Section header */}
      <div style={{ marginBottom:'14px', display:'flex', alignItems:'center', gap:'8px' }}>
        <CreditCard size={15} color="#D9B84C" />
        <h2 style={{ fontSize:'0.78rem', fontWeight:700, color:'#7A7068', letterSpacing:'0.12em', textTransform:'uppercase', margin:0 }}>
        ...
        <div style={{ display:'flex', gap:'8px', justifyContent:'center' }}>
          {(['left', 'any', 'right'] as const).map((b) => (
            <button key={b} onClick={() => setSelectedBay(b)} style={{
              ...
              border: selectedBay === b ? '2px solid #D9B84C' : '2px solid rgba(217, 184, 76,0.2)',
              background: selectedBay === b ? 'rgba(217, 184, 76,0.08)' : '#FFFFFF',
              color: selectedBay === b ? '#B8860B' : '#7A7068',
      ...
      <div style={{ background:'#FFFFFF', border:'1.5px solid rgba(217, 184, 76,0.2)', borderRadius:'20px', padding:'20px', marginBottom:'16px', boxShadow:'0 4px 20px rgba(0,0,0,0.04)' }}>
        ...
        {qrToken ? (
          ...
          <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:'16px', padding:'20px 0' }}>
            <div style={{ width:'180px', height:'180px', borderRadius:'12px', background:'rgba(217, 184, 76,0.04)', border:'2px dashed rgba(217, 184, 76,0.2)', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:'8px' }}>
              <QrCodeIcon size={40} color="rgba(217, 184, 76,0.35)" />
              <p style={{ margin:0, color:'rgba(217, 184, 76,0.5)', fontSize:'0.75rem', textAlign:'center' }}>
                {he ? 'לחץ להפעלת קוד QR' : 'Tap to activate QR'}
              </p>
            </div>
            <Button onClick={generateQr} disabled={isGenerating} style={{ background:'linear-gradient(135deg,#D9B84C,#D9B84C)', color:'#fff', border:'none', fontWeight:700, padding:'12px 32px', borderRadius:'12px', fontSize:'0.9rem' }}>
      ...
      <div style={{ background:'#FFFFFF', border:`1.5px solid ${canWash ? 'rgba(34,197,94,0.3)' : 'rgba(217, 184, 76,0.2)'}`, borderRadius:'16px', padding:'16px', marginBottom:'16px' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'10px', marginBottom:'12px' }}>
          <Droplets size={18} color={canWash ? '#22c55e' : '#D9B84C'} />
          <div>
      ...
      <div style={{ background:'#FFFFFF', border:'1.5px solid rgba(217, 184, 76,0.2)', borderRadius:'16px', padding:'16px', marginBottom:'16px' }}>
        ...
        {[
          ...
          return (
            <div key={svc.id} style={{ display:'flex', alignItems:'center', gap:'12px', padding:'12px 0', borderBottom:'1px solid rgba(217, 184, 76,0.08)' }}>
      ...
      <div style={{ background:'#FFFFFF', border:'1.5px solid rgba(217, 184, 76,0.15)', borderRadius:'16px', padding:'16px', marginBottom:'16px' }}>
        <div onClick={() => setPetEditOpen((o: boolean) => !o)} style={{ display:'flex', alignItems:'center', gap:'10px', cursor:'pointer' }}>
          ...
          <span style={{ color:'#0a0a0a', fontSize:'0.75rem' }}>{petEditOpen ? '▲' : '▼'}</span>
        </div>
        {petEditOpen && (
          <div style={{ marginTop:'14px', display:'flex', flexDirection:'column', gap:'10px' }}>
            ...
            }} style={{ padding:'11px', borderRadius:'10px', border:'none', background: petForm.petName?.trim() ? '#D9B84C' : 'rgba(217, 184, 76,0.3)', color:'#FFFFFF', fontWeight:700, fontSize:'0.88rem', cursor: savingPet ? 'wait' : 'pointer' }}>
      ...
      {/* Apple / Google Wallet */}
      <div style={{ background:'#FFFFFF', border:'1.5px solid rgba(217, 184, 76,0.2)', borderRadius:'16px', padding:'20px', marginBottom:'16px' }}>
        <h3 style={{ fontSize:'0.78rem', fontWeight:700, color:'#7A7068', letterSpacing:'0.1em', textTransform:'uppercase', margin:'0 0 12px' }}>
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes qrGlow {
          0%,100% { box-shadow: 0 0 0 0 rgba(217, 184, 76,0); }
          40%      { box-shadow: 0 0 22px 6px rgba(217, 184, 76,0.28); }
          60%      { box-shadow: 0 0 28px 10px rgba(217, 184, 76,0.18); }
        }
      ...
      <div style={{
        ...
        borderRadius: '24px',
        overflow: 'hidden',
        boxShadow: '0 32px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(217, 184, 76,0.3)',
        position: 'relative',
      }}>
        {/* Gold shimmer top */}
        <div style={{ height: '3px', background: 'linear-gradient(90deg,#D9B84C,#f0d060,#D9B84C,#f0d060,#D9B84C)' }} />
        ...
        <div style={{ padding: '20px 20px 0', textAlign: 'center' }}>
          ...
          {/* Prestige label */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: 'linear-gradient(90deg,#D9B84C,#D9B84C,#D9B84C)', borderRadius: '100px', padding: '3px 14px', marginBottom: '14px' }}>
        ...
        {/* Divider */}
        <div style={{ height: '1px', background: 'linear-gradient(90deg, transparent, rgba(217, 184, 76,0.3), transparent)', margin: '0 20px' }} />
        ...
        <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', animation: 'kioskQrIn 0.3s ease' }}>
          {qrToken ? (
            <>
              ...
              <div style={{ position: 'relative', display: 'inline-flex' }}>
                ...
                <div style={{
                  ...
                  border: '1.5px solid rgba(217, 184, 76,0.2)',
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                {(['left', 'any', 'right'] as const).map((b) => (
                  <button key={b} onClick={() => { setSelectedBay(b); generateQr(); }} style={{
                    ...
                    border: selectedBay === b ? '1.5px solid #D9B84C' : '1.5px solid rgba(217, 184, 76,0.15)',
                    background: selectedBay === b ? 'rgba(217, 184, 76,0.08)' : 'transparent',
                    color: selectedBay === b ? '#B8860B' : '#BFAC8A',
              ...
              <button onClick={generateQr} style={{
                ...
                color: 'rgba(217, 184, 76,0.6)', fontSize: '0.65rem', fontWeight: 500, padding: '2px 6px',
              }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', padding: '20px 0' }}>
              <div style={{ width: '200px', height: '200px', borderRadius: '16px', background: 'rgba(217, 184, 76,0.04)', border: '2px dashed rgba(217, 184, 76,0.25)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
                <QrCodeIcon size={44} color="rgba(217, 184, 76,0.35)" />
                <p style={{ margin: 0, color: 'rgba(217, 184, 76,0.55)', fontSize: '0.75rem', textAlign: 'center' }}>
                  {he ? 'לחץ להפעלת קוד QR' : 'Tap to activate QR'}
                </p>
              </div>
              <Button onClick={generateQr} disabled={isGenerating} style={{ background: 'linear-gradient(135deg,#D9B84C,#D9B84C)', color: '#fff', border: 'none', fontWeight: 700, padding: '12px 36px', borderRadius: '12px', fontSize: '0.9rem' }}>
        ...
        {/* Divider */}
        <div style={{ height: '1px', background: 'linear-gradient(90deg, transparent, rgba(217, 184, 76,0.2), transparent)', margin: '0 20px' }} />
        ...
        <div style={{ padding: '14px 20px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '0.88rem', fontWeight: 800, color: '#0a0a0a' }}>
              {balances.loyaltyPoints.toLocaleString()}
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '0 20px 16px', display: 'flex', gap: '6px', justifyContent: 'center' }}>
          {(['left', 'any', 'right'] as const).map((b) => (
            <button key={b} onClick={() => { setSelectedBay(b); generateQr(); }} style={{
              ...
              border: selectedBay === b ? '2px solid #D9B84C' : '2px solid rgba(217, 184, 76,0.18)',
              background: selectedBay === b ? 'rgba(217, 184, 76,0.1)' : '#FFFFFF',
              color: selectedBay === b ? '#B8860B' : '#9E9E9E',
              fontWeight: selectedBay === b ? 700 : 500,
        ...
        {/* Valid footer */}
        <div style={{ background: 'rgba(217, 184, 76,0.04)', padding: '8px 20px 14px', textAlign: 'center', borderTop: '1px solid rgba(217, 184, 76,0.1)' }}>
      ...
      <Layout>
        <div style={{ minHeight:'80vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#FFFFFF' }}>
          <div style={{ textAlign:'center' }}>
            <div style={{ width:'56px', height:'56px', borderRadius:'50%', border:'3px solid rgba(217, 184, 76,0.2)', borderTopColor:'#D9B84C', animation:'spin 1s linear infinite', margin:'0 auto 16px' }} />
      ...
      <Layout>
        <div style={{ minHeight:'60vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#FFFFFF', padding:'2rem' }}>
          <div style={{ textAlign:'center', maxWidth:'320px' }}>
            ...
            <a href="/signin" style={{ display:'inline-block', background:'linear-gradient(135deg,#D9B84C,#D9B84C)', color:'#fff', fontWeight:600, padding:'10px 28px', borderRadius:'8px', textDecoration:'none', fontSize:'0.95rem' }}>
  ...
  return (
    <Layout>
      <style>{`
        ...
        @keyframes passButtonPulse { 0%,100% { box-shadow:0 4px 20px rgba(217, 184, 76,0.35); } 50% { box-shadow:0 4px 32px rgba(217, 184, 76,0.6); } }
      `}</style>
      ...
      <button
        ...
        style={{
          ...
          zIndex: 100,
          background: 'linear-gradient(135deg,#D9B84C 0%,#D9B84C 50%,#D9B84C 100%)',
          color: '#FFFFFF',
          border: 'none',
          borderRadius: '100px',
          padding: '14px 28px',
      ...
      <div style={{ background:'#FFFFFF', minHeight:'100vh', paddingBottom:'calc(180px + env(safe-area-inset-bottom, 0px))' }}>
        ...
        {loyaltyProfile && (
          <div style={{ background: '#FFFFFF', padding: '0 20px 24px', borderBottom: '1px solid rgba(217, 184, 76,0.10)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', marginBottom: '16px' }}>
              ...
              {loyaltyProfile.currentStreak > 0 && (
                <div style={{
                  flex: 1, background: 'linear-gradient(135deg, rgba(217, 184, 76,0.06), rgba(217, 184, 76,0.02))',
            ...
            {loyaltyProfile.tierThreshold > 0 && (
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                  ...
                  <span style={{ fontSize: '0.68rem', fontWeight: 700, color: '#0a0a0a' }}>
                    {loyaltyProfile.tierProgress.toLocaleString()} / {loyaltyProfile.tierThreshold.toLocaleString()}
                  </span>
                </div>
                <div style={{ height: '5px', background: 'rgba(217, 184, 76,0.12)', borderRadius: '100px', overflow: 'hidden' }}>
                  <div style={{
                    height: '100%',
                    width: `${Math.min(100, Math.round((loyaltyProfile.tierProgress / loyaltyProfile.tierThreshold) * 100))}%`,
                    background: 'linear-gradient(90deg, #D9B84C, #f0d060, #D9B84C)',
                    borderRadius: '100px',
        ...
        <div style={{
          ...
          borderRadius: '20px',
          overflow: 'hidden',
          border: '1px solid rgba(217, 184, 76,0.2)',
          boxShadow: '0 8px 32px rgba(0,0,0,0.12)',
        }}>
          {/* Gold top strip */}
          <div style={{ height: '2px', background: 'linear-gradient(90deg,#D9B84C,#f0d060,#D9B84C,#D9B84C)' }} />
          ...
          <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              <Crown size={14} color="#D9B84C" />
              <span style={{ fontSize: '0.6rem', fontWeight: 700, color: 'rgba(217, 184, 76,0.7)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              >
                ...
                <ChevronRight size={14} color="rgba(217, 184, 76,0.5)" />
              </a>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <div style={{ width: '32px', height: '32px', borderRadius: '10px', background: 'rgba(217, 184, 76,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <Phone size={14} color="#D9B84C" />
                  </div>
                  <div>
