          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center luxury-animate-slide-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                {/* The customer's own grooming bookings. Its only static link
                    used to live in the deleted booking-wizard page, which left
                    the dashboard unreachable (the quick-action list below builds
                    its href dynamically, so nothing static pointed at it). */}
