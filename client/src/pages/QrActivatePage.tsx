    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#D9B84C]/10 mb-4">
            <Waves className="w-8 h-8 text-[#0a0a0a]" />
          </div>
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-gray-200 p-5">
              <div className="flex items-center gap-2 mb-3">
                <QrCode className="w-4 h-4 text-[#0a0a0a]" />
        ...
        {step === 'ready' && (
          <div className="space-y-4">
            <div className="rounded-2xl border border-[#D9B84C]/30 bg-[#D9B84C]/5 p-5">
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-[#0a0a0a] mt-0.5 shrink-0" />
              ...
              {priceCents !== null && (
                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-[#D9B84C]/20">
