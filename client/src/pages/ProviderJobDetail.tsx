      ...
      <div className="max-w-md mx-auto pb-28">
        ...
        {b && (
          <>
            ...
            {/* Customer-confirmed / auto-approved payout panel.
                Shipped 2026-08-18 (#1909) and DELETED 30 minutes later by
                #1882, whose branch was cut before it and carried a stale copy
                of this file. Its regression pin has failed ever since, sitting
                in the red baseline where nobody read it. Restored 2026-09-18
                on top of the canonical-status migration #1882 also brought.

                Without it the provider sees a silent pill flip from "Awaiting
                your confirmation" to "Completed" when the customer confirms
                (or the 24h cron auto-approves) — no payout amount, no rating,
                no review. */}
                ...
                <div className="rounded-2xl p-4 border border-emerald-200 bg-emerald-50">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {b.ownerReview && (
                        <p className="text-xs text-emerald-900 mt-2 italic leading-relaxed border-l-2 border-emerald-300 pl-2 break-words">
                          "{b.ownerReview}"
                        </p>
                      )}
                    </div>
