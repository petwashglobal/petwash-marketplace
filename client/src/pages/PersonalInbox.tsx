      ...
      <Layout>
        <div className="bg-white min-h-screen flex items-center justify-center px-4">
          <div className="text-center bg-white border border-gray-200 shadow-sm p-10 rounded-2xl max-w-md w-full">
            <Lock className="w-14 h-14 mx-auto mb-6 text-[#0a0a0a]" />
                ...
                {(['all', 'unread', 'starred'] as const).map((f) => (
                  <Button
                    ...
                    className={cn(
                      ...
                      filter === f
                        ? 'bg-gradient-to-r from-[#D9B84C] to-[#D9B84C] text-white shadow-sm'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white border border-gray-200 shadow-sm rounded-2xl overflow-hidden">
                <div className="h-0.5 bg-gradient-to-r from-transparent via-[#D9B84C]/40 to-transparent" />
                        ...
                        return (
                          <Button
                            ...
                            className={cn(
                              ...
                              isUnread && 'border-l-2 border-l-[#D9B84C]'
                            )}
                            data-testid={`message-item-${msg.id}`}
                          >
                            <div className="flex items-start justify-between mb-1.5">
                              <div className="flex items-center gap-2 min-w-0">
                                {isUnread && <div className="w-2 h-2 rounded-full bg-[#D9B84C] flex-shrink-0" />}
                              ...
                              <div className="flex items-center gap-1.5 flex-shrink-0">
                                ...
                                {msg.isStarred && <Star className="w-3.5 h-3.5 fill-[#D9B84C] text-[#0a0a0a]" />}
                              </div>
                            </div>
                ...
                <div className="bg-white border border-gray-200 shadow-sm rounded-2xl overflow-hidden">
                  ...
                  <div className="p-6 border-b border-gray-100">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <Star className={cn('w-4 h-4', selectedMessage.isStarred ? 'fill-[#D9B84C] text-[#0a0a0a]' : 'text-gray-400')} />
                        </Button>
                        <Button
                  ...
                  <div className="p-6 sm:p-8">
                    ...
                    <div className="bg-white border border-gray-100 rounded-xl p-5 space-y-3">
                      <p className="text-gray-500 text-[10px] uppercase tracking-widest text-[#0a0a0a] mb-3 flex items-center gap-1.5">
