...
function styles() {
  return `
    ...
    .sh-eyebrow{ display:inline-block; font-size:12.5px; font-weight:800; letter-spacing:.18em; text-transform:uppercase; color:#9d6f23; padding:8px 14px; border:1px solid #F4D77A; border-radius:999px; background:linear-gradient(180deg,#fffdf6,#fdf5dc); margin-bottom:18px }
