...
function eventMeta(eventType: string, amountCents: number): EventMeta {
  ...
  if (eventType === "redeem") return { icon: "🛒", color: "text-[#0a0a0a]", sign: "negative" };
  ...
  return (
    <div className="flex items-start gap-3 px-5 py-4">
      ...
      <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 mt-0.5 text-base
        ${isPositive ? "bg-emerald-50" : entry.eventType === "redeem" ? "bg-[#D9B84C]/10" : "bg-white"}`}>
        {meta.icon}
      </div>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          ...
          <span className={`text-sm font-bold shrink-0 ${
            isPositive ? "text-emerald-600" : entry.eventType === "expire" ? "text-gray-400" : "text-[#0a0a0a]"
          }`}>
      ...
      <div className="flex-1 overflow-y-auto pb-24">
        ...
        {entries.length > 0 && (
          <div className="mx-5 mt-4 grid grid-cols-2 gap-3">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              <div className="flex items-center gap-2 mb-1">
                <TrendingDown className="w-4 h-4 text-[#0a0a0a]" />
        ...
        {/* ── Explanation footer ─────────────────────────────────────────── */}
        <div className="mx-5 mt-4 mb-6 p-4 bg-[#D9B84C]/5 rounded-2xl border border-[#D9B84C]/15">
