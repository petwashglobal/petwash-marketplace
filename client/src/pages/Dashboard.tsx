...
const dashText: Record<string, Record<string, string>> = {
  ...
  privilege: {
    en: 'PetWash Privilege',
    he: 'PetWash Privilege',
    ar: 'PetWash Privilege',
    es: 'PetWash Privilege',
    fr: 'PetWash Privilege',
    ru: 'PetWash Privilege',
  },
...
// vs the old #B8860B (2.9:1, failed AA / Israeli accessibility law).
// Still unmistakably gold — same tone already used for the membership badge.
const goldText = { color: '#8A6A1B' };
const cardBorder = '1px solid rgba(217, 184, 76, 0.2)';
const cardShadow = '0 2px 16px rgba(0, 0, 0, 0.07), 0 0 0 0.5px rgba(217, 184, 76, 0.08)';
const divider = '1px solid rgba(217, 184, 76, 0.12)';
        ...
        <div className="relative z-10 w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl mx-auto px-5 sm:px-6 pt-5 pb-10">
          ...
          <motion.div
            ...
            style={{
              ...
              border: '1px solid rgba(217, 184, 76,0.45)',
              boxShadow: '0 4px 20px rgba(217, 184, 76,0.12), 0 1px 4px rgba(0,0,0,0.06)',
            }}
          >
              ...
              <div className="px-5 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs px-2 py-0.5 rounded-full font-semibold"
                    style={{ background: 'rgba(217, 184, 76,0.15)', color: '#D4AF37', border: '1px solid rgba(217, 184, 76,0.3)' }}>
                    {he ? 'פתח' : 'Open'}
                  </span>
            ...
            {/* Divider */}
            <div style={{ height: '1px', background: 'rgba(217, 184, 76,0.12)', marginInline: '16px' }} />
            ...
            <div className="px-4 py-3 flex gap-2">
              ...
              <button
                ...
                style={{ background: '#111111', color: '#ffffff', border: '1px solid rgba(0,0,0,0.15)', cursor: 'pointer' }}
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold"
                style={{ background: '#000000', color: '#ffffff', border: '1px solid rgba(255,255,255,0.14)', cursor: 'pointer' }}
              >
                {/* Official full-colour Google "G" mark */}
