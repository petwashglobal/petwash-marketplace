          ...
          <div className="space-y-6">
            <div className="luxury-glass-panel p-8 luxury-animate-fade-in luxury-delay-1">
              ...
              <div className="space-y-4 luxury-text-body">
                <p>
                  ⁦PetWash™⁩ מחויבת להנגשת אתר האינטרנט והאפליקציה שלה לאנשים עם מוגבלות,
            ...
            <div className="luxury-glass-panel p-8 luxury-animate-fade-in luxury-delay-7 border-l-4 border-[#D4AF37]">
              ...
              <div className="space-y-4 luxury-text-body">
                <p className="font-semibold">צוות הנגישות של ⁦PetWash™⁩ לשירותכם</p>
            ...
            <div className="luxury-glass-panel p-8 luxury-animate-fade-in luxury-delay-10">
              ...
              <div className="space-y-4 luxury-text-body">
                <p>⁦PetWash™⁩ רואה בנגישות ערך מרכזי ופועלת באופן מתמיד:</p>
                <ul className="list-disc mr-6 space-y-2">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6">
          <div className="luxury-glass-panel p-8 luxury-animate-fade-in luxury-delay-1">
            ...
            <div className="space-y-4 luxury-text-body">
              <p>
                ⁦PetWash™⁩ is committed to making our website and app accessible to people with disabilities,
          ...
          <div className="luxury-glass-panel p-8 luxury-animate-fade-in luxury-delay-5 border-l-4 border-[#D4AF37]">
            ...
            <div className="space-y-4 luxury-text-body">
              <p className="font-semibold">⁦PetWash™⁩ Accessibility Team at your service</p>
