          ...
          >
            ...
            >
              {socialLoading === 'google' ? (
                ...
                // PR signup-google-button-polish: official 4-color Google "G"
                // mark per Google brand guidelines. Matches the SVG in
                // SignIn.tsx and the version PR #303 shipped to /admin/login-v2.
                // FaGoogle from react-icons renders a single-color glyph which
                // does not match the brand mark.
                <svg
