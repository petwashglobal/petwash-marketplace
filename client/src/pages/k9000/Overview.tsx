...
// K9000_FAQ moved to @/content/k9000Faq (2026-09-13) so /support renders the
// same reviewed copy instead of a "coming soon" badge.
...
export default function K9000Overview() {
  ...
  return (
    <Layout>
      ...
      <SeoFaqSection faq={K9000_FAQ} isHebrew={isRtl} />
    </Layout>
  );
}
