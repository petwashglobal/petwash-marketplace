  ...
  if (user && !switchingAccount) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        ...
        >
          <div className="w-16 h-16 rounded-full mx-auto flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #D9B84C, #D9B84C)' }}>
        ...
        >
          ...
          {!selectedIntent && !user && !magicLinkEmailNeeded && (
            ...
            >
              ...
              <Button
                ...
                variant="outline"
                className="w-full h-12 text-sm font-medium border border-neutral-200 !bg-white hover:!bg-white hover:!border-[#D4AF37] !text-neutral-800 rounded-none tracking-wider uppercase transition-all"
              ...
              >
                {socialLoading === 'google' ? (
                  ...
                  <>
                    <svg className="w-5 h-5 me-3 flex-shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                {socialLoading === 'apple' ? (
                  ...
                  <>
                    <svg className="w-5 h-5 me-3 flex-shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          ...
          >
            <Button
              ...
              disabled={!!socialLoading}
              variant="outline"
              className="w-full h-13 text-sm font-medium border border-neutral-200 !bg-white hover:!bg-white hover:!border-[#D4AF37] !text-neutral-800 rounded-none tracking-wider uppercase transition-all"
