        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          >
            <Button
              ...
              style={{ background: 'linear-gradient(90deg, #12936A, #12936A)', color: '#0f0d08' }}
    ...
    return (
      <Layout language={language} onLanguageChange={setLanguage}>
        <div className="min-h-screen flex items-center justify-center bg-white">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #12936A 0%, #12936A 100%)', borderRadius: '2px' }}>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="space-y-5">
                ...
                <Button
                  ...
                  style={{ borderRadius: '2px', background: 'linear-gradient(90deg, #12936A, #12936A)', color: '#0f0d08', padding: '14px 24px' }}
                  onClick={() => {
                    trackEvent({
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                <Link href="/privilege">
                  <Button className="px-8 py-3 text-sm font-bold" style={{ borderRadius: '2px', background: 'linear-gradient(90deg, #12936A, #12936A)', color: '#0f0d08' }}>
