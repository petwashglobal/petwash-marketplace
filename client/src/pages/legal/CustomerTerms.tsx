...
export default function CustomerTerms() {
  return (
    <LegalPage
      titleHe="תנאי שימוש ללקוח / חבר מועדון"
    ...
    >
      <LegalSection titleHe="1. כשירות וחשבון" titleEn="1. Eligibility & account">
        <LegalList
          items={[
            ...
            ["עליך למסור מידע נכון, מלא ומעודכן בעת ההרשמה ובמהלך השימוש.", "You must provide accurate, complete, and current information at sign-up and throughout use."],
            ["אתה אחראי לשמירת סודיות פרטי הגישה לחשבונך ולכל פעולה שתתבצע דרכו.", "You are responsible for keeping your login credentials confidential and for all activity under your account."],
          ]}
        />
      </LegalSection>
      ...
      <LegalSection titleHe="3. אחריות בעל חיית המחמד" titleEn="3. Pet-owner responsibility">
        <LegalList
          items={[
            ...
            ["אין להשתמש בשירות אם חיית המחמד חולה, פצועה, תוקפנית או אינה כשירה לשטיפה.", "Do not use the service if your pet is sick, injured, aggressive, or otherwise unfit to be washed."],
          ]}
        />
      </LegalSection>
      ...
      <LegalSection titleHe="4. אחריות בשימוש בעמדה ובהזמנה" titleEn="4. Station-use & booking responsibility">
        <LegalList
          items={[
            ...
            ["בעת ביצוע הזמנה אתה אחראי לפרטים שתמסור, למועד, ולנוכחותך/נוכחות בעל הסמכות במקום.", "When booking, you are responsible for the details you provide, the timing, and your (or an authorised person's) presence."],
          ]}
        />
      </LegalSection>
      ...
      <LegalSection titleHe="5. תשלומים ועמלות" titleEn="5. Fees & payment">
        <LegalList
          items={[
            ...
            ["המחיר המוצג כולל מע\"מ וכל תוספת רלוונטית במועד הצגתו לראשונה.", "The displayed price includes VAT and any applicable surcharge at the first moment it is shown."],
            ["שירותי תשלום כפופים לחוק שירותי תשלום, התשע\"ט-2019 ולדין החל.", "Payment services are subject to the Payment Services Law, 2019, and applicable law."],
          ]}
        />
      </LegalSection>
      ...
      <LegalSection titleHe="6. ארנק ו-eGift" titleEn="6. Wallet & eGift">
        <LegalList
          items={[
            ...
            ["PetWash רשאית לדרוש אימות חשבון ולקשר יתרה לחשבון מזוהה לצורך מניעת הונאה.", "PetWash may require account verification and may lock a balance to an identified account to prevent fraud."],
          ]}
        />
        <LegalParagraph
          he='לפירוט מלא ראו את "תנאי ארנק ו-eGift".'
          en='See the "Wallet & eGift Terms" for full details.'
        />
      </LegalSection>
      ...
      <LegalSection titleHe="7. ביטול והחזר כספי" titleEn="7. Cancellation & refunds">
        ...
        />
        <LegalParagraph
          he='ראו פירוט לכל סוג שירות ב"מדיניות ביטול והחזר".'
          en='See the "Cancellation & Refund Policy" for per-service detail.'
        />
      </LegalSection>
