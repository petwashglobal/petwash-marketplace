...
const MESSAGES: Record<ValidationKey, { en: string; he: string }> = {
  ...
  'validation.email.invalid': { en: 'Please enter a valid email address', he: 'יש להזין כתובת אימייל תקינה' },
  'validation.phone.invalid': { en: 'Please enter a valid phone number', he: 'יש להזין מספר טלפון תקין' },
  'validation.id.invalid': { en: 'Please enter a valid ID number', he: 'יש להזין מספר תעודת זהות תקין' },
  'validation.postalCode.invalid': { en: 'Please enter a valid postal code', he: 'יש להזין מיקוד תקין' },
  'validation.name.required': { en: 'Please enter your full name', he: 'יש להזין שם מלא' },
  ...
  'validation.date.required': { en: 'Please select a date', he: 'יש לבחור תאריך' },
  'validation.date.invalid': { en: 'Please enter a valid date', he: 'יש להזין תאריך תקין' },
  ...
  'validation.pet.nameRequired': { en: "Please enter your pet's name", he: 'יש להזין את שם חיית המחמד' },
  'validation.pet.dobFuture': { en: "Birth date can't be in the future", he: 'תאריך הלידה לא יכול להיות עתידי' },

  'validation.booking.petRequired': { en: 'Please select a pet', he: 'יש לבחור חיית מחמד' },
  'validation.booking.dateRequired': { en: 'Please select booking dates', he: 'יש לבחור תאריכי הזמנה' },
  'validation.booking.startInPast': { en: 'Start date cannot be in the past', he: 'תאריך ההתחלה לא יכול להיות בעבר' },

  'validation.payment.amountInvalid': { en: 'Please enter a valid amount', he: 'יש להזין סכום תקין' },
  ...
  'validation.provider.serviceRequired': { en: 'Please select at least one service', he: 'יש לבחור לפחות שירות אחד' },

  'validation.pawFinder.petTypeRequired': { en: 'Please select the pet type', he: 'יש לבחור סוג חיה' },
  'validation.pawFinder.locationRequired': { en: 'Please provide a location or area', he: 'אנא ציין מיקום או אזור' },
  'validation.pawFinder.contactRequired': { en: 'Please choose a contact preference', he: 'יש לבחור אופן יצירת קשר' },

  'validation.incident.descriptionRequired': { en: 'Please describe what happened', he: 'אנא תאר מה קרה' },

  'validation.gift.recipientRequired': { en: "Please enter the recipient's email or mobile", he: 'יש להזין אימייל או נייד של הנמען' },
};
