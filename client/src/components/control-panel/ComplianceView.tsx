...
export default function ComplianceView() {
  ...
  // Mock data for demo - ONLY when API succeeded but returned empty (not during errors!)
  const mockContractors: ContractorComplianceData[] = (!error && !isLoading && contractors.length === 0) ? [
    {
      contractorId: "c1",
      contractorName: "Sarah Cohen",
    ...
    },
    {
      ...
      complianceStatus: {
        ...
        latestDecision: {
          decision: "rejected",
          score: 0.0,
          reasons: ["IDENTITY_VERIFICATION_REQUIRED", "CRIMINAL_CHECK_REQUIRED"],
          createdAt: new Date().toISOString(),
        },
      },
    },
    {
      ...
      complianceStatus: {
        ...
        criminal: {
          status: "record_found",
          blockingOffenses: ["DRIVING_UNDER_INFLUENCE"],
        },
        driver: {
          hasValidLicense: true,
          hasActiveBan: true,
          declaresCleanRecord: false,
          pointsOnLicense: 8,
        },
        ratings: {
          count: 89,
