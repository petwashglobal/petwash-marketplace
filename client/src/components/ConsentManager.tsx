...
export function ConsentManager({ language, isOpen, onClose, onSave }: ConsentManagerProps) {
  ...
  const text = {
    en: {
      ...
      description: '⁦PetWash™⁩ uses cookies and similar technologies to provide essential services, improve your experience, and analyze usage. We comply with Israeli Privacy Protection Law and GDPR.',
      necessary: 'Necessary',
      ...
      promotionalNotificationsDesc: 'Get special discounts, offers, and news from ⁦PetWash™⁩.',
    ...
    he: {
      ...
      description: '⁦PetWash™⁩ משתמשת בעוגיות וטכנולוגיות דומות לאספקת שירותים חיוניים, שיפור החוויה וניתוח השימוש. אנו עומדים בחוק הגנת הפרטיות הישראלי ו-GDPR.',
      necessary: 'נחוצות',
      ...
      promotionalNotificationsDesc: 'קבל הנחות מיוחדות, הצעות וחדשות מ-⁦PetWash™⁩.',
      acceptAll: 'אישור הכל',
