    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-6 sm:mb-10">
          ...
          <p className="text-[10px] sm:text-[11px] tracking-[0.12em] uppercase font-semibold text-[#0a0a0a] mb-1">
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden transition-all duration-500 bg-white hover:-translate-y-1"
                  style={{ 
                    boxShadow: isPopular
                      ? '0 0 0 1.5px #D9B84C, 0 12px 40px rgba(217, 184, 76,0.14)'
                  ...
                  <div className="px-3 sm:px-4 py-3 sm:py-4">
                    ...
                    <div className="border-t border-[#eee] pt-2 space-y-1 text-[#888] mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-medium" style={{ color: '#0a0a0a' }}>
                          {t('packages.k9000Only', language)}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      {pkg.washCount >= 10 && (
                        <div className="flex items-center gap-2">
                          <Sparkles className="w-3 h-3 shrink-0" strokeWidth={1.5} style={{ color: '#0a0a0a' }} />
                          <span className="text-[10px] sm:text-[11px]">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col items-center gap-2">
          <div className="flex items-center gap-2 text-center">
            <Lock className="w-3 h-3 text-[#0a0a0a] shrink-0" strokeWidth={1.5} />
          ...
          <div className="grid grid-cols-3 gap-8 sm:gap-16 max-w-xl mx-auto">
            <div className="text-center">
              <div className="w-10 h-10 mx-auto mb-3 rounded-full flex items-center justify-center">
                <Check className="w-4 h-4 text-[#0a0a0a]" strokeWidth={1.5} />
              </div>
            ...
            <div className="text-center">
              <div className="w-10 h-10 mx-auto mb-3 rounded-full flex items-center justify-center">
                <Crown className="w-4 h-4 text-[#0a0a0a]" strokeWidth={1.5} />
              </div>
              <p className="text-[10px] sm:text-[11px] tracking-[0.08em] text-[#555] font-medium uppercase">
            ...
            <div className="text-center">
              <div className="w-10 h-10 mx-auto mb-3 rounded-full flex items-center justify-center">
                <Leaf className="w-4 h-4 text-[#0a0a0a]" strokeWidth={1.5} />
              </div>
              <p className="text-[10px] sm:text-[11px] tracking-[0.08em] text-[#555] font-medium uppercase">
