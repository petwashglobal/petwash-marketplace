                    ...
                    >
                      ...
                      <div className="relative aspect-[4/3] rounded-3xl overflow-hidden mb-4 bg-white">
                        ...
                        <div className="absolute top-3 left-3 flex gap-1.5 flex-wrap max-w-[calc(100%-3.5rem)]">
                          {showTopProvider && (
                            <div className="flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-semibold text-[#0a0a0a] shadow-md" style={{ background: 'linear-gradient(135deg, #D9B84C, #a8893e)' }}>
