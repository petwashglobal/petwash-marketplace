...
const serviceData = [
  ...
  },
  {
    ...
    description: "Premium DIY wash with natural products",
    descriptionHe: "שטיפה עצמית פרימיום עם מוצרים טבעיים",
    features: ["24/7 access", "Natural shampoo", "Tea tree oil"],
    featuresHe: ["גישה 24/7", "שמפו טבעי", "שמן עץ התה"],
    priceFrom: 55,
    route: "/k9000",
