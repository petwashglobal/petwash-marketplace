      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <Sparkles className="w-4 h-4 text-[#0a0a0a]" strokeWidth={1.2} />
          ...
          {user ? (
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3" data-testid="wallet-buttons-member">
              ...
              <Link
                href="/prestige-pass"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 bg-white text-[#1a1a1a] text-sm font-medium tracking-wide border border-[#ddd] hover:border-[#D9B84C] transition-all duration-300"
                style={{ borderRadius: '10px' }}
                data-testid="cta-google-wallet"
              >
                <Wallet className="w-5 h-5 text-[#0a0a0a]" strokeWidth={1.5} />
