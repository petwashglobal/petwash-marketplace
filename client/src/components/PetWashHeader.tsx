...
const T: Record<string, Record<string, string>> = {
  ...
  "hub.label": { en: "PetWash Hub", he: "מרכז ⁦PetWash™⁩", ru: "Центр ⁦PetWash™⁩", fr: "Centre ⁦PetWash™⁩", es: "Centro ⁦PetWash™⁩", ar: "مركز ⁦PetWash™⁩" },
  ...
  "stations.label": { en: "PetWash Stations", he: "תחנות ⁦PetWash™⁩", ru: "Станции ⁦PetWash™⁩", fr: "Stations ⁦PetWash™⁩", es: "Estaciones ⁦PetWash™⁩", ar: "محطات ⁦PetWash™⁩" },
  ...
  "sitter.label": { en: "Pet Sitter Suite", he: "Pet Sitter Suite", ru: "Pet Sitter Suite", fr: "Pet Sitter Suite", es: "Pet Sitter Suite", ar: "Pet Sitter Suite" },
  ...
  "walker.label": { en: "Walk My Pet", he: "Walk My Pet", ru: "Walk My Pet", fr: "Walk My Pet", es: "Walk My Pet", ar: "Walk My Pet" },
  ...
  "transport.label": { en: "PetTrek", he: "PetTrek", ru: "PetTrek", fr: "PetTrek", es: "PetTrek", ar: "PetTrek" },
  ...
  "loyalty-club.label": { en: "PetWash Prestige", he: "PetWash Prestige", ru: "PetWash Prestige", fr: "PetWash Prestige", es: "PetWash Prestige", ar: "PetWash Prestige" },
  "loyalty-tiers.label": { en: "Tiers: Member, Silver, Gold, Platinum, Diamond, Emerald, Black Reserve", he: "דרגות: Member, Silver, Gold, Platinum, Diamond, Emerald, Black Reserve", ru: "Уровни: Member, Silver, Gold, Platinum, Diamond, Emerald, Black Reserve", fr: "Niveaux : Member, Silver, Gold, Platinum, Diamond, Emerald, Black Reserve", es: "Niveles: Member, Silver, Gold, Platinum, Diamond, Emerald, Black Reserve", ar: "المستويات: Member، Silver، Gold، Platinum، Diamond، Emerald، Black Reserve" },
  ...
  "about.label": { en: "About PetWash", he: "אודות ⁦PetWash™⁩", ru: "О ⁦PetWash™⁩", fr: "À propos de ⁦PetWash™⁩", es: "Acerca de ⁦PetWash™⁩", ar: "حول ⁦PetWash™⁩" },
...
export const PetWashHeader: React.FC<PetWashHeaderProps> = ({ 
  ...
  // Menu links navigate INSIDE the app (2026-09-13). Every tap used to be
  // window.location.assign — a full reload that re-downloaded the bundle,
  // re-booted Firebase and flashed the page, on every menu item. Only the
  // account-resolution, sign-in/up and log-out paths keep the hard navigation
  // (they need a fresh auth boot). The drawer closes first so its body scroll
  // lock is released; useScrollToTop handles the new route's scroll position.
      ...
      <header className="pw-header" role="banner">
        ...
        <div className="pw-header-row-controls">
          ...
          <nav className="pw-nav-desktop">
                      ...
                      <div className="pw-mega-column" key={group.id} role="group" aria-label={t(group.titleKey, currentLanguage)}>
                        ...
                        {group.items.map((item) => (
                          <button
                            ...
                            onClick={() => { if (item.frozen) return; goTo(item.href); }}
                          >
            ...
            <div className="pw-nav-item">
              <button type="button" className="pw-nav-link" style={{ touchAction: 'manipulation', cursor: 'pointer' }} onClick={() => goTo("/loyalty")}>
                {t("nav.loyalty", currentLanguage)}
              </button>
            </div>
            <div className="pw-nav-item">
              <button type="button" className="pw-nav-link" style={{ touchAction: 'manipulation', cursor: 'pointer' }} onClick={() => goTo("/egift")}>
        ...
        <div className="pw-mobile-nav-strip">
          <div className="pw-mobile-nav-strip-row">
            <button type="button" className="pw-mobile-nav-strip-link" style={{ touchAction: 'manipulation', cursor: 'pointer' }} onClick={() => goTo("/egift")}>
              {t("nav.giftCards", currentLanguage)}
            </button>
            <span className="pw-mobile-nav-strip-dot">·</span>
            <button type="button" className="pw-mobile-nav-strip-link" style={{ touchAction: 'manipulation', cursor: 'pointer' }} onClick={() => goTo("/loyalty")}>
              {t("nav.loyalty", currentLanguage)}
            </button>
            <span className="pw-mobile-nav-strip-dot">·</span>
