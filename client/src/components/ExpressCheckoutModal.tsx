        ...
        <form ref={formRef} onSubmit={handleSubmit} className="px-5 py-5 space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <Input
                ...
                required
                className={`${isRtl ? 'pr-9' : 'pl-9'} border-[#ddd] bg-white text-[#1a1a1a] placeholder:text-[#bbb] focus:border-[#D9B84C] focus:ring-0 rounded-none text-[16px]`}
                dir="ltr"
                autoComplete="email"
                autoCapitalize="none"
                enterKeyHint="next"
            ...
            <>
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={2}
                  className="mt-1 border-[#ddd] bg-white text-[#1a1a1a] placeholder:text-[#bbb] focus:border-[#D9B84C] focus:ring-0 rounded-none text-[16px] resize-none"
                  dir={dir}
          ...
          <div className="flex items-start gap-2 py-1">
            ...
            <label htmlFor="checkout-terms" className="text-[11px] text-[#888] leading-relaxed cursor-pointer select-none">
              {tx('termsAccept', lang)}{' '}
              <a href="/terms" target="_blank" className="text-[#0a0a0a] hover:underline">{tx('termsLink', lang)}</a>
              {' '}{tx('andPrivacy', lang)}{' '}
              <a href="/privacy-policy" target="_blank" className="text-[#0a0a0a] hover:underline">{tx('privacyLink', lang)}</a>
            </label>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 pt-2 pb-1">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[9px] text-[#ccc] tracking-wider">
                {tx('poweredBy', lang)} <span className="font-medium text-[#aaa]">Nayax</span> · ⁦PetWash™⁩
              </span>
            </div>
          </div>
        </form>
