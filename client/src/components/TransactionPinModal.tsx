      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: "0 32px 80px rgba(0,0,0,0.75), 0 0 0 1px rgba(217, 184, 76,0.2)",
          }}
        >
          {/* Top gold accent bar */}
          <div style={{
            height: 2,
            background: "linear-gradient(90deg, transparent, #F0D060 20%, #D9B84C 50%, #F0D060 80%, transparent)",
          }} />
          ...
          <div className="pt-8 pb-5 px-8 text-center">
              ...
              <svg viewBox="0 0 64 64" width="62" height="62" fill="none">
                <defs>
                  <linearGradient id="pinDiaGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="50%"  stopColor="#D9B84C" />
                ...
                {/* Side facet lines */}
                <line x1="32" y1="5"  x2="7"  y2="29" stroke="rgba(217, 184, 76,0.25)" strokeWidth="0.4" />
                <line x1="32" y1="5"  x2="57" y2="29" stroke="rgba(217, 184, 76,0.25)" strokeWidth="0.4" />
              </svg>
            </div>
            ...
            <p style={{
              ...
              background: "linear-gradient(90deg, #F0D060, #D9B84C, #F0D060)",
          ...
          <div className="mx-8 mb-6" style={{
            height: 1,
            background: "linear-gradient(90deg, transparent, rgba(217, 184, 76,0.35), transparent)",
          }} />
            ...
            {Array.from({ length: 6 }).map((_, i) => {
              ...
              return (
                <div key={i} style={{
                  ...
                  height: 13,
                  borderRadius: "50%",
                  border: filled ? "none" : "1.5px solid rgba(217, 184, 76,0.38)",
                  background: filled
                    ? "linear-gradient(135deg, #F0D060 0%, #D9B84C 50%, #B8860B 100%)"
                    : "transparent",
                  boxShadow: filled
                    ? "0 0 12px rgba(217, 184, 76,0.65), 0 0 4px rgba(217, 184, 76,0.4)"
                    : "none",
          ...
          <div className="text-center mb-1 min-h-[22px] px-6">
            {loading ? (
              <span style={{
                ...
                background: "linear-gradient(90deg, #F0D060, #D9B84C)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                fontFamily: "'Cormorant Garamond', serif",
              }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: isPressed
                      ? "1.5px solid #D9B84C"
                      : "1.5px solid rgba(217, 184, 76,0.14)",
                    background: isPressed
                      ? "rgba(217, 184, 76,0.12)"
                    ...
                    boxShadow: isPressed
                      ? "0 0 18px rgba(217, 184, 76,0.28), inset 0 1px 0 rgba(217, 184, 76,0.18)"
                      : "none",
          ...
          <div className="text-center py-5">
            <button
              ...
              style={{
                ...
                fontSize: 12,
                letterSpacing: "0.1em",
                backgroundImage: "linear-gradient(90deg, #F0D060, #D9B84C, #F0D060)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                fontFamily: "'Cormorant Garamond', serif",
                fontWeight: 500,
