        ...
        <div className="p-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[rgba(217, 184, 76,0.2)] to-[rgba(217, 184, 76,0.1)] flex items-center justify-center">
        ...
        <div className="p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[rgba(217, 184, 76,0.25)] to-[rgba(217, 184, 76,0.1)] flex items-center justify-center">
                <Wallet className="w-5 h-5 text-[#0a0a0a]" />
              </div>
              <div>
                <h3 className="luxury-dark-heading-sm text-lg">⁦PetWash™⁩ Wallet</h3>
