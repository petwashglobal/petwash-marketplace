      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-6 sm:mb-10">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <Gift className="w-4 h-4 text-[#0a0a0a]" strokeWidth={1.2} />
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden transition-all duration-500 bg-white hover:shadow-xl hover:shadow-black/[0.06]"
                  style={{
                    borderRadius: '6px',
                    border: isPremium ? '1.5px solid #D9B84C' : isElite ? '1.5px solid #D9B84C' : '1px solid #eee',
                  }}
                >
                  {isElite && (
        ...
        <div className="mt-8 sm:mt-10 flex flex-col items-center gap-2">
          <div className="flex items-center gap-2">
            <Lock className="w-3 h-3 text-[#0a0a0a]" strokeWidth={1.5} />
