    ...
    en: {
      passkey: {
        ...
        dataItems: [
          ...
          '🚫 ⁦PetWash™⁩ NEVER receives, stores, or has access to your biometric information',
        ...
        appleItems: [
          ...
          '⁦PetWash™⁩ complies with Apple\'s biometric data usage policies',
        ...
        googleItems: [
          ...
          '⁦PetWash™⁩ complies with Google Play biometric policies',
        ...
        microsoftItems: [
          ...
          '⁦PetWash™⁩ complies with Microsoft identity platform policies',
          'Manage in Settings → Accounts → Sign-in options'
        ],
        consent1: 'I consent to using my device\'s biometric authentication (Face ID/Touch ID/Windows Hello) for secure sign-in to ⁦PetWash™⁩',
        consent2: 'I understand that my biometric data is processed locally on my device and ⁦PetWash™⁩ never receives or stores this sensitive information',
      ...
      faceid: {
        ...
        icon: Smartphone,
        description: 'Use Face ID for secure, password-free authentication to your ⁦PetWash™⁩ account.',
        method: 'Face ID (TrueDepth Camera)',
      },
      touchid: {
        title: 'Enable Touch ID Authentication',
        icon: Fingerprint,
        description: 'Use Touch ID for secure, password-free authentication to your ⁦PetWash™⁩ account.',
        method: 'Touch ID (Fingerprint Sensor)',
      },
      windowshello: {
        title: 'Enable Windows Hello',
        icon: Lock,
        description: 'Use Windows Hello for secure, password-free authentication to your ⁦PetWash™⁩ account.',
    ...
    he: {
      passkey: {
        ...
        dataItems: [
          ...
          '🚫 ⁦PetWash™⁩ לעולם לא מקבלת, מאחסנת או ניגשת למידע הביומטרי שלך',
      ...
      faceid: {
        ...
        icon: Smartphone,
        description: 'השתמש ב-Face ID לאימות מאובטח ללא סיסמה לחשבון ⁦PetWash™⁩ שלך.',
        method: 'Face ID (מצלמת TrueDepth)',
      },
      touchid: {
        title: 'הפעלת אימות Touch ID',
        icon: Fingerprint,
        description: 'השתמש ב-Touch ID לאימות מאובטח ללא סיסמה לחשבון ⁦PetWash™⁩ שלך.',
        method: 'Touch ID (חיישן טביעת אצבע)',
      },
      windowshello: {
        title: 'הפעלת Windows Hello',
        icon: Lock,
        description: 'השתמש ב-Windows Hello לאימות מאובטח ללא סיסמה לחשבון ⁦PetWash™⁩ שלך.',
