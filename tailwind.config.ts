  ...
  theme: {
    extend: {
      ...
      colors: {
        'luxury-dark': '#18181B',
        'brand-accent': '#C02222',
        // CARTIER 18K YELLOW GOLD - Exact match from Love bracelet reference
        'cartier-gold': '#C9A227',
        'cartier-gold-light': '#E8C252',
        'cartier-gold-dark': '#A67C00',
        'cartier-gold-highlight': '#F0DC82',
        'cartier-gold-shadow': '#8B6914',
        // GLOBAL OVERRIDE: Remap all purple/violet/indigo to Cartier Gold palette
        purple: {
          50: '#FDF8E1',
          100: '#F9EEC3',
          200: '#F0DC82',
