// FILE: src/modules/pet-sitter/PetSitterProfilePage.tsx
 ...
 */
const PetSitterProfilePage: React.FC<PetSitterProfileProps> = (props) => {
  const {
    sitterName,
    sitterTagline,
    locationLabel,
  ...
  const [stayType, setStayType] = React.useState<StayType>("sitterHome");
