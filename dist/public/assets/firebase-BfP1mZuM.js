const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.esm--abeT1Ee.js","assets/index.esm-JkJ6nAKP.js","assets/index-ClkDmZYJ.js","assets/index-BFc441jo.css"])))=>i.map(i=>d[i]);
import{_ as tf}from"./index-ClkDmZYJ.js";const nf=()=>{};var ac={};/**
 * @license
...
Please check your .env file or Replit Secrets configuration.`),{apiKey:"placeholder-api-key",authDomain:"placeholder.firebaseapp.com",projectId:"placeholder-project",storageBucket:"placeholder.appspot.com",messagingSenderId:"000000000000",appId:"1:000000000000:web:placeholder",measurementId:"G-PLACEHOLDER"}):(console.log("[Firebase] ℹ️ Using build-time config (fallback)",{hasRuntimeConfig:!!(typeof window<"u"&&window.__FIREBASE_CONFIG__),environment:"production"}),n)}const oo=ET(),Rr=Lp().length===0?Ju(oo):Zu();is.info("ℹ️ App Check disabled (VITE_FIREBASE_APPCHECK_SITE_KEY not set) - fail-open mode");const wd=bm(Rr,{persistence:[mg,ng],popupRedirectResolver:n_});wd.useDeviceLanguage();const IT=sI(Rr,{cacheSizeBytes:40*1024*1024,experimentalAutoDetectLongPolling:!0});zI(Rr,"gs://signinpetwash.firebasestorage.app");async function TT(){return null}if(typeof window<"u"){const n="signinpetwash",e=oo.projectId;window.__PW_FIREBASE_CONFIG__={recaptchaSiteKey:"✅ present",appCheckSiteKey:"ℹ️ not-used (fail-open)",appCheckEnabled:!1,authDomain:oo.authDomain,projectId:e,projectIdRaw:n,projectIdFixed:n!==e?"✅ CORRECTED":"using env var",environment:"production"},console.log("[Firebase] Runtime Config:",window.__PW_FIREBASE_CONFIG__)}const zu=async()=>{try{const{getPerformance:n,trace:e}=await tf(async()=>{const{getPerformance:s,trace:o}=await import("./index.esm--abeT1Ee.js");return{getPerformance:s,trace:o}},__vite__mapDeps([0,1,2,3])),t=n(Rr),r=e(t,"home_initial_paint");if(r.start(),"PerformanceObserver"in window)try{const s=new PerformanceObserver(o=>{try{const a=o.getEntries();a[a.length-1]&&(r.stop(),s.disconnect())}catch(a){is.debug("PerformanceObserver entry processing failed",a),setTimeout(()=>r.stop(),2500)}});s.observe({type:"largest-contentful-paint",buffered:!0})}catch(s){is.debug("PerformanceObserver setup failed",s),setTimeout(()=>r.stop(),2500)}else setTimeout(()=>r.stop(),2500)}catch(n){is.warn("Firebase Performance init failed (fail-safe mode)",n)}};typeof window<"u"&&("requestIdleCallback"in window?requestIdleCallback(zu,{timeout:3e3}):setTimeout(zu,0));const YT=Object.freeze(Object.defineProperty({__proto__:null,app:Rr,auth:wd,db:IT,getAppCheckToken:TT},Symbol.toStringTag,{value:"Module"}));export{ar as $,KT as A,DT as B,Ye as C,ST as D,En as E,zT as F,Et as G,HT as H,GT as I,LT as J,VT as K,bs as L,TT as M,Tf as N,AT as O,et as P,rr as Q,MT as R,FT as S,Z as T,ng as U,Zf as V,RT as W,QT as X,go as Y,mo as Z,uo as _,XT as a,Tn as a0,yt as a1,It as a2,zt as a3,Tt as a4,n_ as a5,rg as a6,Gm as a7,am as a8,wc as a9,mg as aa,bm as ab,Kp as ac,lm as ad,zm as ae,YT as af,wd as b,$T as c,IT as d,BT as e,Rr as f,qT as g,PT as h,rI as i,WT as j,bT as k,is as l,CT as m,Zu as n,xT as o,ce as p,vT as q,Qu as r,UT as s,z as t,at as u,kT as v,xe as w,Rf as x,NT as y,OT as z};
