import{H as R,D as k,F as P,_ as E,E as J,a0 as z,Z as Q}from"./firebase-BUKsUf1y.js";import{a3 as je,a4 as $e,a5 as Be,a6 as Ue,U as He,a7 as We,G as Ge,a8 as Ke,S as Je,a9 as ze,R as Qe,aa as Xe,r as Ye,P as Ze,ab as et,ac as tt,ad as nt,t as at,u as rt,p as st,ae as ot,g as it,af as ct,ag as ut,ah as dt,o as ft,ai as lt,aj as pt,M as gt,V as ht,O as wt,ak as mt,h as It,n as At,Q as Tt,s as St,e as bt,x as kt,J as Pt,v as yt}from"./firebase-BUKsUf1y.js";import"./index-YBRcqbx3.js";const v="@firebase/installations",A="0.6.19";/**
 * @license
 ...
 */const N=1e4,q=`w:${A}`,_="FIS_v2",X="https://firebaseinstallations.googleapis.com/v1",Y=60*60*1e3,Z="installations",ee="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G="installations",_e="installations-internal",Oe=e=>{const t=e.getProvider("app").getImmediate(),n=qe(t),a=E(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},Fe=e=>{const t=e.getProvider("app").getImmediate(),n=E(t,G).getImmediate();return{getId:()=>Ee(n),getToken:s=>ve(n,s)}};function De(){k(new P(G,Oe,"PUBLIC")),k(new P(_e,Fe,"PRIVATE"))}De();R(v,A);R(v,A,"esm2020");export{je as ActionCodeURL,$e as AuthCredential,Be as EmailAuthCredential,Ue as EmailAuthProvider,He as FacebookAuthProvider,We as GithubAuthProvider,Ge as GoogleAuthProvider,Ke as OAuthCredential,Je as OAuthProvider,ze as PhoneAuthCredential,Qe as RecaptchaVerifier,Xe as TwitterAuthProvider,Ye as applyActionCode,Ze as browserLocalPersistence,et as browserPopupRedirectResolver,tt as browserSessionPersistence,nt as checkActionCode,at as confirmPasswordReset,rt as createUserWithEmailAndPassword,st as getAdditionalUserInfo,ot as getIdTokenResult,it as getRedirectResult,ct as inMemoryPersistence,ut as indexedDBLocalPersistence,dt as initializeAuth,ft as onAuthStateChanged,lt as prodErrorMap,pt as reload,gt as sendPasswordResetEmail,ht as sendSignInLinkToEmail,wt as setPersistence,mt as signInWithCredential,It as signInWithCustomToken,At as signInWithEmailAndPassword,Tt as signInWithPhoneNumber,St as signInWithPopup,bt as signInWithRedirect,kt as signOut,Pt as updateProfile,yt as verifyPasswordResetCode};
