const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.esm-B8wi5zXR.js","assets/index.esm-DN5Gm1DI.js","assets/index-BgxHWiJC.js","assets/index-11uS1jrg.css"])))=>i.map(i=>d[i]);
import{_ as tf}from"./index-BgxHWiJC.js";const nf=()=>{};var ac={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hp(n){at(new Ye("platform-logger",e=>new np(e),"PRIVATE")),at(new Ye("heartbeat",e=>new qp(e),"PRIVATE")),xe(Oi,fc,n),xe(Oi,fc,"esm2020"),xe("fire-js","")}Hp("");var Wp="firebase",Gp="12.7.0";/**
 * @license
