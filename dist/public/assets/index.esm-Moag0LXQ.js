import{A as E,z as b,C as P,_ as R,E as J,a2 as z,V as X}from"./firebase-BYxx2JN4.js";import{a6 as xe,a7 as $e,a8 as Be,a9 as He,J as Ue,aa as We,G as Ke,ab as Ge,O as Je,ac as ze,P as Xe,R as Ye,ad as Ze,k as Qe,$ as et,ae as tt,a0 as nt,af as at,m as rt,n as st,H as ot,ag as it,X as ct,ah as ut,Z as dt,ai as ft,K as lt,Y as pt,aj as gt,ak as ht,F as mt,N as wt,a1 as It,al as At,g as Tt,o as kt,M as St,e as bt,s as Pt,D as yt,I as Ct,u as Et,v as Rt}from"./firebase-BYxx2JN4.js";import"./index-cuYQ0Vrd.js";const v="@firebase/installations",A="0.6.19";/**
 * @license
 ...
 */const N=1e4,q=`w:${A}`,_="FIS_v2",Y="https://firebaseinstallations.googleapis.com/v1",Z=60*60*1e3,Q="installations",ee="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K="installations",_e="installations-internal",Oe=e=>{const t=e.getProvider("app").getImmediate(),n=qe(t),a=R(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},Fe=e=>{const t=e.getProvider("app").getImmediate(),n=R(t,K).getImmediate();return{getId:()=>Re(n),getToken:s=>ve(n,s)}};function De(){b(new P(K,Oe,"PUBLIC")),b(new P(_e,Fe,"PRIVATE"))}De();E(v,A);E(v,A,"esm2020");export{xe as ActionCodeURL,$e as AuthCredential,Be as EmailAuthCredential,He as EmailAuthProvider,Ue as FacebookAuthProvider,We as GithubAuthProvider,Ke as GoogleAuthProvider,Ge as OAuthCredential,Je as OAuthProvider,ze as PhoneAuthCredential,Xe as PhoneAuthProvider,Ye as RecaptchaVerifier,Ze as TwitterAuthProvider,Qe as applyActionCode,et as browserLocalPersistence,tt as browserPopupRedirectResolver,nt as browserSessionPersistence,at as checkActionCode,rt as confirmPasswordReset,st as createUserWithEmailAndPassword,ot as getAdditionalUserInfo,it as getIdTokenResult,ct as getRedirectResult,ut as inMemoryPersistence,dt as indexedDBLocalPersistence,ft as initializeAuth,lt as isSignInWithEmailLink,pt as onAuthStateChanged,gt as prodErrorMap,ht as reload,mt as sendPasswordResetEmail,wt as sendSignInLinkToEmail,It as setPersistence,At as signInWithCredential,Tt as signInWithCustomToken,kt as signInWithEmailAndPassword,St as signInWithEmailLink,bt as signInWithPopup,Pt as signInWithRedirect,yt as signOut,Ct as updatePhoneNumber,Et as updateProfile,Rt as verifyPasswordResetCode};
