import{w as E,u as b,C as y,_ as R,E as J,V as z,P as Y}from"./firebase-BfP1mZuM.js";import{Y as $e,Z as je,$ as Be,a0 as Ue,a1 as He,a2 as We,G as Ke,a3 as Ge,a4 as Je,k as ze,U as Ye,a5 as Xe,a6 as Ze,a7 as Qe,m as et,y as tt,J as nt,a8 as at,g as rt,a9 as st,aa as ot,ab as it,o as ct,ac as ut,ad as dt,D as ft,K as lt,R as pt,ae as gt,h as ht,B as wt,s as mt,e as It,S as Tt,z as At,v as St}from"./firebase-BfP1mZuM.js";import"./index-ClkDmZYJ.js";const v="@firebase/installations",T="0.6.19";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Re(e){const t=e,{installationEntry:n,registrationPromise:a}=await S(t);return a?a.catch(console.error):k(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ve(e,t=!1){const n=e;return await Ne(n),(await k(n,t)).token}async function Ne(e){const{registrationPromise:t}=await S(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K="installations",_e="installations-internal",Oe=e=>{const t=e.getProvider("app").getImmediate(),n=qe(t),a=R(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},De=e=>{const t=e.getProvider("app").getImmediate(),n=R(t,K).getImmediate();return{getId:()=>Re(n),getToken:s=>ve(n,s)}};function Fe(){b(new y(K,Oe,"PUBLIC")),b(new y(_e,De,"PRIVATE"))}Fe();E(v,T);E(v,T,"esm2020");export{$e as ActionCodeURL,je as AuthCredential,Be as EmailAuthCredential,Ue as EmailAuthProvider,He as FacebookAuthProvider,We as GithubAuthProvider,Ke as GoogleAuthProvider,Ge as OAuthCredential,Je as TwitterAuthProvider,ze as applyActionCode,Ye as browserLocalPersistence,Xe as browserPopupRedirectResolver,Ze as browserSessionPersistence,Qe as checkActionCode,et as confirmPasswordReset,tt as createUserWithEmailAndPassword,nt as getAdditionalUserInfo,at as getIdTokenResult,rt as getRedirectResult,st as inMemoryPersistence,ot as indexedDBLocalPersistence,it as initializeAuth,ct as onAuthStateChanged,ut as prodErrorMap,dt as reload,ft as sendPasswordResetEmail,lt as sendSignInLinkToEmail,pt as setPersistence,gt as signInWithCredential,ht as signInWithCustomToken,wt as signInWithEmailAndPassword,mt as signInWithPopup,It as signInWithRedirect,Tt as signOut,At as updateProfile,St as verifyPasswordResetCode};
