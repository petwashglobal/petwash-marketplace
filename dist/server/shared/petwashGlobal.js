...
export const kycConfig = {
    ...
    levels: {
        ...
        STANDARD: {
            id: "STANDARD",
            description: "National ID or passport, selfie match, address. For walkers, sitters, drivers, groomers.",
            requiredFields: [
                "fullName",
                "email",
                "phone",
...
export const paymentOrchestrationConfig = {
    primaryGateway: "NAYAX",
    k9000Gateway: "NAYAX",
    marketplaceGateway: "NAYAX",
    ...
    escrowConfig: {
        ...
        providerPayoutMethod: "ISRAELI_BANK_TRANSFER",
    },
};
// ============================================================================
 ...
 */
export function getAccessibleNavItems(platformId, userRole) {
