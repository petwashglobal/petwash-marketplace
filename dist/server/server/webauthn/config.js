 ...
 */
export function verifyChallenge(signedData) {
    try {
 ...
 */
export function storeChallengeInCookie(res, challenge, req) {
 ...
 */
export function retrieveChallengeFromCookie(req) {
 ...
 */
export function clearChallengeFromCookie(res) {
 ...
 */
export function isAttestationFormatAllowed(format) {
    return ATTESTATION_POLICY.acceptedFormats.includes(format);
}
/**
 * Validate Apple attestation
 * Placeholder for production implementation
 */
export function validateAppleAttestation(attestationObject) {
 ...
 * Placeholder for production implementation
 */
export function validateAndroidAttestation(attestationObject) {
