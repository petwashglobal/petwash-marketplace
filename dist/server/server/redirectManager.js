...
export function setupRedirectManager(app) {
...
export function setupCustom404Handler(app) {
...
function generateCustom404HTML(requestPath, host) {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
