 ...
 */
export function generateNewUserConfirmationEmail(params) {
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>${isHebrew
        ...
        : 'We\'re thrilled to have you join the Pet Wash™ family. Your account is now active and ready to use.'}</p>
      ...
      <p>${isHebrew
        ...
        : 'You now have access to all our services: K9000™ wash stations, Pet Sitting, Dog Walking, Pet Transport, and more!'}</p>
 ...
 */
export function generateLoyaltyEnrollmentEmail(params) {
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>${isHebrew
        ...
        : 'Welcome to Pet Wash™\'s exclusive 7-Star Loyalty Club.'}</p>
      ...
      <p>${isHebrew
        ...
        : 'Earn points with every service and climb our 7-Star ladder for exclusive benefits!'}</p>
 ...
 */
export function generateProviderEnrollmentEmail(params) {
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>${isHebrew
        ...
        : 'Thank you for applying to join the Pet Wash™ provider team. We\'ve received your application and will review it shortly.'}</p>
