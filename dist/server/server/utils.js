...
export function calculateLoyaltyTier(totalSpent, washCount) {
...
export function getDiscountDescription(loyaltyTier, isVerifiedSenior, isVerifiedDisability, language = 'en') {
    const descriptions = {
        en: {
    ...
    return descriptions[language][loyaltyTier] || descriptions[language].regular;
}
