...
export async function translateWithGemini(text, targetLanguage, sourceLanguage, context) {
 ...
 */
function buildTranslationPrompt(targetLanguage, sourceLanguage, context) {
 ...
 */
export async function batchTranslate(texts, targetLanguage, sourceLanguage, context) {
    try {
        ...
        const translationPromises = texts.map(text => translateWithGemini(text, targetLanguage, sourceLanguage, context));
...
export async function healthCheck() {
    ...
    try {
        // Test translation
        const testResult = await translateWithGemini('Hello world', 'es', 'en', 'Test translation for health check');
        const responseTime = Date.now() - startTime;
        return {
