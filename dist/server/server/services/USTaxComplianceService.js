import { db } from '../db';
import { usFederalTaxFilings, usStateTaxFilings, usStateNexus, } from '@shared/schema';
...
export class USTaxComplianceService {
    ...
    async calculateQuarterlyTaxLiability(quarter, year) {
        return {
            federalIncome: 0,
    ...
    async getStateSalesTaxRate(state) {
        const stateTaxRates = {
            CA: 7.25,
            TX: 6.25,
            FL: 6.0,
