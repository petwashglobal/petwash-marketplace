...
import { db } from "../db";
import { providerCommissions, contractorProfiles, providerTaxCompliance, } from "@shared/schema";
...
export class IsraeliInvoiceGenerator {
     ...
     */
    static async generateInvoice(commissionId, language = "he") {
        try {
     ...
     */
    static generateHebrewInvoice(doc, commission, contractor, taxProfile) {
        // Header - Company Info
        doc
            .fontSize(20)
            .font("Helvetica-Bold")
     ...
     */
    static generateEnglishInvoice(doc, commission, contractor, taxProfile) {
        // Header - Company Info
        doc
            .fontSize(20)
            .font("Helvetica-Bold")
        ...
        doc
            ...
            .fontSize(8)
            .font("Helvetica")
            .text("This invoice was issued in accordance with Value Added Tax Regulations, 1976", { align: "center" })
     ...
     */
    static generateFilename(commissionId, language = "he") {
