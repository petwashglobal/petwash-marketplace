 ...
 */
import { COUNTRY_TO_LANGUAGE } from '../../shared/languages';
export class GeolocationService {
     ...
     */
    async hasLocationTrackingConsent(userId) {
     ...
     */
    async detectCountryFromIP(ip, userId) {
     ...
     */
    async validateSameCountry(ownerLocation, sitterLocation) {
        ...
        if (ownerCountry === sitterCountry) {
            return {
                ...
                ownerCountry,
                sitterCountry,
                distance: this.calculateDistance(ownerLocation.latitude, ownerLocation.longitude, sitterLocation.latitude, sitterLocation.longitude),
            };
        }
        return {
            isValid: false,
     ...
     */
    getCountryRestrictions(countryCode) {
