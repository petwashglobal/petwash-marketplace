 ...
 */
export async function sendSecurityAlert(subject, html) {
    if (!process.env.SENDGRID_API_KEY) {
 ...
 */
export async function checkFailedBurst(uid, userEmail) {
 ...
 */
export async function alertPasskeyRevoked(uid, credentialId, userEmail, deviceLabel) {
 ...
 */
export async function alertNewDeviceIfUnusual(uid, ip, userEmail, city) {
    try {
