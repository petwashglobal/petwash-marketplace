...
export class SocialAuthVerificationService {
     ...
     */
    static async verifySocialToken(provider, firebaseToken, additionalInfo) {
        try {
     ...
     */
    static async createSocialUser(uid, email, provider, profile) {
        const userData = {
            uid,
            email,
     ...
     */
    static async linkSocialAccount(existingUserId, socialProvider, socialUid) {
        try {
