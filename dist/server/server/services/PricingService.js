...
export class PricingService {
     ...
     */
    async calculateFinalPrice(basePrice, userId, isEGift = false) {
        try {
     ...
     */
    async getVariableDiscount(discountGroup) {
        try {
     ...
     */
    getDefaultDiscount(discountGroup) {
        const defaults = {
     ...
     */
    async updateVariableDiscount(discountGroup, newRate, adminUid) {
        try {
            // Validate rate
     ...
     */
    async validateDiscountEligibility(userId, discountGroup) {
        try {
            const [user] = await db
                .select()
                .from(users)
