...
export class SitterProximitySearch {
     ...
     */
    async findSittersNearby(userLocation, radiusKm = 25, serviceType) {
        try {
            ...
            const sittersWithDistance = mockSitters
                ...
                .map(sitter => {
                const distance = this.calculateDistance(userLocation.latitude, userLocation.longitude, sitter.latitude, sitter.longitude);
                return {
                    id: sitter.id,
     ...
     */
    async isEligibleToBook(userId, loyaltyTier) {
