...
export class SitterSecurityManager {
     ...
     */
    async performSitterVetting(userId, idScanData, countryCode, ipAddress) {
        try {
     ...
     */
    monitorDirectMessages(senderId, recipientId, messageContent) {
     ...
     */
    async callExternalIDApi(vettingApi, idScanData, countryCode) {
     ...
     */
    async callExternalBackgroundCheck(countryCode, userId) {
     ...
     * Enforce 2FA setup
     */
    async enforceTwoFactorSetup(userId) {
