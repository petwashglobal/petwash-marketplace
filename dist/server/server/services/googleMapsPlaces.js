...
export class GoogleMapsPlacesService {
     ...
     */
    async getPlaceDetails(placeId, language = 'iw') {
        try {
            const fields = [
                'place_id',
                'name',
     ...
     */
    async searchPlaces(query, language = 'iw') {
        try {
     ...
     */
    async getBatchReviews(placeIds, language = 'iw') {
     ...
     */
    async generateReviewSummary(reviews, language = 'he') {
        try {
...
export function initializeGoogleMapsPlaces(apiKey) {
    placesService = new GoogleMapsPlacesService(apiKey);
    return placesService;
}
export function getGoogleMapsPlaces() {
    if (!placesService) {
