...
export class PlatformService {
    ...
    async listPlatforms(includeInactive = false) {
    ...
    async createPlatform(input, actorUserId) {
        const settings = {
    ...
    async updatePlatform(id, input, actorUserId) {
        ...
        if (input.nameHe !== undefined)
            updateData.nameHe = input.nameHe;
        if (input.description !== undefined)
            updateData.description = input.description;
        if (input.descriptionHe !== undefined)
            updateData.descriptionHe = input.descriptionHe;
        if (input.isActive !== undefined)
            updateData.isActive = input.isActive;
        if (input.platformFeePercent !== undefined)
            updateData.platformFeePercent = input.platformFeePercent.toString();
        if (input.bookingMode !== undefined)
            updateData.bookingMode = input.bookingMode;
        if (input.nayaxEnabled !== undefined)
            updateData.nayaxEnabled = input.nayaxEnabled;
    ...
    async toggleFeature(platformId, feature, enabled, actorUserId) {
    ...
    async logEvent(eventType, aggregateType, aggregateId, payload, actorUserId) {
