 ...
 */
export function getWeatherConditionTranslation(condition, lang = 'en') {
    return weatherConditions[condition]?.[lang] || condition;
}
/**
 * Get translated recommendation
 */
export function getRecommendationTranslation(rating, field, lang = 'en', isRain = false) {
 ...
 */
export function getFallbackAdviceText(key, field, lang = 'en') {
 ...
 */
export function getBasicRecommendationText(key, lang = 'en') {
 ...
 */
export function getLabelText(key, lang = 'en') {
