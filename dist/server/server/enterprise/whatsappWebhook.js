 ...
 */
async function findAvailableStaff(customerPhone) {
    try {
 ...
 */
async function sendFCMNotification(staffUid, message, customerPhone) {
    try {
 ...
 */
export async function sendWhatsAppMessage(to, message, fromStaffUid) {
    try {
