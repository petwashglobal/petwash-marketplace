 ...
 */
export async function fetchMizrahiAccountData(req, res) {
    try {
 ...
 */
async function classifyNewTransactions(count) {
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            const category = await classifyTransactionDescription(txData.description, txData.amount, txData.type);
 ...
 */
async function classifyTransactionDescription(description, amount, type) {
