 ...
 */
async function extractTextFromReceipt(imageUrl) {
    try {
 ...
 */
async function classifyExpenseWithAI(receiptText) {
    try {
 ...
 */
export async function processReceiptForBookkeeping(receiptId, receiptData) {
    try {
 ...
 */
export async function reprocessFailedReceipts(franchiseId) {
    try {
 ...
 */
export async function getExpenseSummary(franchiseId, startDate, endDate) {
    try {
