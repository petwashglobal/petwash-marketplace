 ...
 * toMinorUnit(5000, 'JPY') // 5000 yen
 */
export function toMinorUnit(amountDecimal, currency = 'ILS') {
 ...
 */
export function fromMinorUnit(amountMinor, currency = 'ILS') {
    // Get minor units for currency (default to 2 if unknown)
    const minorUnits = CURRENCY_MINOR_UNITS[currency.toUpperCase()] ?? 2;
    // Validate amount
 ...
 */
export function formatMinorUnit(amountMinor, currency = 'ILS', locale = 'en-US') {
