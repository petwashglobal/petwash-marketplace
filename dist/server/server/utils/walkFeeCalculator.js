 ...
 */
export function calculateWalkFees(basePriceCents) {
 ...
 */
export function calculateWalkFeesByDuration(walkerHourlyRateCents, durationMinutes) {
 ...
 */
export function validateWalkFeeCalculation(fees) {
