 ...
 */
function isWithinBirthdayWindow(dob, currentDate = new Date()) {
 ...
 */
function getCurrentBirthdayYear(dob, currentDate = new Date()) {
 ...
 */
async function hasUsedBirthdayCouponThisYear(uid, birthdayYear) {
    try {
 ...
 */
async function getUserDateOfBirth(uid) {
    try {
 ...
 */
export async function checkBirthdayCouponEligibility(uid) {
    try {
 ...
 */
export async function markBirthdayCouponUsed(uid, orderId, discountAmount, originalPrice, finalPrice, packageId, birthdayYear) {
    try {
