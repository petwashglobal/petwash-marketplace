...
export function setupCustomerAuth(app) {
    ...
    app.post("/api/customer/register", async (req, res) => {
        try {
            const { firstName, lastName, email, phone, password, dateOfBirth, country, gender, petType, loyaltyProgram, reminders, marketing, termsAccepted } = req.body;
...
export const isCustomerAuthenticated = (req, res, next) => {
