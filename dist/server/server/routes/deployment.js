 ...
 */
router.post('/deployment/canary/check', async (req, res) => {
    try {
 ...
 */
router.post('/deployment/canary/monitor', async (req, res) => {
    try {
 ...
 */
router.post('/deployment/canary/reset', (req, res) => {
    resetCanaryCounters();
 ...
 */
router.post('/deployment/release', async (req, res) => {
    try {
 ...
 */
router.post('/deployment/rollback', async (req, res) => {
    try {
