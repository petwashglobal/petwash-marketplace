...
import { db } from '../db';
import { walkerProfiles, sitterProfiles, trainers, drivers, marketplaceSearchFiltersSchema, } from '@shared/schema';
 ...
 */
async function searchWalkers(filters) {
    try {
 ...
 */
async function searchSitters(filters) {
    try {
 ...
 */
async function searchGroomers(filters) {
    try {
        const conditions = [
