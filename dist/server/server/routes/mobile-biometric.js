...
const MOBILE_CONFIG = {
    ...
    userVerification: 'required', // ✅ CRITICAL: Enforce biometric/PIN (NIST SP 800-63B AAL2)
    attestationType: 'none', // For consumer apps (use 'direct' for enterprise)
};
/**
 ...
 */
router.post('/register/options', validateFirebaseToken, verifyAppCheckToken, async (req, res) => {
    try {
 ...
 */
router.post('/register/verify', validateFirebaseToken, verifyAppCheckToken, async (req, res) => {
    try {
        const { uid, email } = req.firebaseUser;
 ...
 */
router.post('/authenticate/options', verifyAppCheckToken, async (req, res) => {
    try {
 ...
 */
router.post('/authenticate/verify', verifyAppCheckToken, async (req, res) => {
    try {
 ...
 */
router.post('/health/consent', validateFirebaseToken, async (req, res) => {
    try {
 ...
 */
router.post('/health/sync', validateFirebaseToken, async (req, res) => {
    try {
        const { uid } = req.firebaseUser;
 ...
 */
router.delete('/health/consent/:platform', validateFirebaseToken, async (req, res) => {
    try {
        const { uid } = req.firebaseUser;
 ...
 */
router.get('/devices', validateFirebaseToken, async (req, res) => {
    try {
        const { uid } = req.firebaseUser;
        const credsSnapshot = await db
            .collection('users')
 ...
 */
router.delete('/devices/:deviceId', validateFirebaseToken, async (req, res) => {
    try {
        const { uid } = req.firebaseUser;
