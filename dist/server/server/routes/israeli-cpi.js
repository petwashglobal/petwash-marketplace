...
router.post('/calculate', async (req, res) => {
    try {
        ...
        const result = await IsraeliCPIService.calculateIndexedAmount(originalAmount, baseMonth, currentMonth);
        res.json(result);
    }
    catch (error) {
 ...
 */
router.post('/calculate-rent', requireAuth, async (req, res) => {
    try {
        ...
        const result = await IsraeliCPIService.calculateRentAdjustment(originalRent, contractStartMonth, adjustmentMonth);
        res.json(result);
    }
    catch (error) {
...
router.post('/add', requireAdmin, async (req, res) => {
    try {
        ...
        const newEntry = await IsraeliCPIService.addCPIIndex(month, indexValue, yearOverYearChange || null, source || 'Manual');
