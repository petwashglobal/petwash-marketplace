...
import { providerTrainingService } from '../services/ProviderTrainingService';
 ...
 */
router.get('/progress/:platform', requireAuth, async (req, res) => {
    try {
        const platform = req.params.platform;
 ...
 */
router.post('/generate-certificate', requireAuth, async (req, res) => {
    try {
        ...
        const certificate = await providerTrainingService.generateCertificate(providerId, platform, providerName);
