...
import { createSubcontractorSignature, SUBCONTRACTOR_AGREEMENT_IL_2025, ISRAEL_SUBCONTRACTOR_COMPLIANCE_2025 } from '../../src/petwash_subcontractor_legal_esign_2025';
 ...
 */
router.post('/2025/sign', async (req, res) => {
    try {
 ...
 */
router.get('/2025/template', async (req, res) => {
    try {
        return res.json({
            ok: true,
            data: {
 ...
 * ⚠️ ROUTING ORDER CRITICAL: This specific route MUST be before /:signatureId
 */
router.get('/2025/contractor/:contractorId', async (req, res) => {
    try {
 ...
 */
router.get('/2025/:signatureId', async (req, res) => {
    try {
