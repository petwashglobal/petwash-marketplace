 ...
 */
router.get('/my-trail', async (req, res) => {
    try {
 ...
 * 🔒 Admin only
 */
router.get('/verify-chain', requireAdmin, async (req, res) => {
    try {
        const startBlock = req.query.startBlock ? parseInt(req.query.startBlock) : undefined;
        const endBlock = req.query.endBlock ? parseInt(req.query.endBlock) : undefined;
 ...
 */
router.post('/create-snapshot', requireAdmin, async (req, res) => {
    try {
 ...
 */
router.post('/record-voucher-redemption', async (req, res) => {
    try {
        const schema = z.object({
 ...
 * 🔒 Authenticated users only
 */
router.post('/record-discount-usage', async (req, res) => {
    try {
        const schema = z.object({
 ...
 */
router.post('/record-biometric-failure', async (req, res) => {
    try {
        const schema = z.object({
