...
import { z } from 'zod';
import { db } from '../../db';
import { settlements, partnerAgreements } from '@shared/schema';
...
router.post('/generate', async (req, res) => {
    try {
        ...
        // Generate settlement
        const settlement = await FinanceSettlementService.generateSettlement(partnerId, startDate, endDate, periodType);
...
router.patch('/:id/approve', async (req, res) => {
    try {
        ...
        const updatedSettlement = await FinanceSettlementService.approveSettlement(settlementId, userId);
...
router.patch('/:id/pay', async (req, res) => {
    try {
        ...
        const updatedSettlement = await FinanceSettlementService.markSettlementPaid(settlementId, paymentReference);
        // Update notes if provided
        if (notes) {
            await db
                .update(settlements)
