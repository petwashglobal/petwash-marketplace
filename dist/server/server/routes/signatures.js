...
async function verifyCEOAccess(req, res, next) {
    const user = req.user;
    if (!user) {
...
router.get("/", verifyCEOAccess, async (req, res) => {
    try {
        const user = req.user;
...
router.post("/", verifyCEOAccess, async (req, res) => {
    try {
        const user = req.user;
...
router.get("/documents", verifyCEOAccess, async (req, res) => {
    try {
        const user = req.user;
...
// Sign a document
router.post("/documents/sign", verifyCEOAccess, async (req, res) => {
    try {
        const user = req.user;
