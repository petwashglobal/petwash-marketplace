...
import { managementAnalytics } from '../services/ManagementAnalyticsService';
...
router.get('/dashboard', async (req, res) => {
    try {
        ...
        const metrics = await managementAnalytics.getComprehensiveMetrics(start, end, period);
 ...
 */
router.get('/service-routing', async (req, res) => {
    try {
