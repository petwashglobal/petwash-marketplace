...
const cronJobStatuses = new Map();
/**
 * Record cron job execution
 */
export async function recordCronExecution(jobName, success, errorMessage) {
    const now = new Date();
 ...
 */
export async function trackFirestoreOperation(operation) {
    const now = new Date();
 ...
 */
export function getFirestoreMetrics() {
...
const nayaxWebhookFailures = [];
/**
 * Track Nayax webhook failure
 */
export async function trackNayaxWebhookFailure(eventId, error) {
    const now = new Date();
 ...
 */
export async function checkPendingNayaxTransactions() {
    try {
 ...
 */
export async function checkInactiveNayaxStations() {
    try {
