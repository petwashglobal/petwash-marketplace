 ...
 */
export async function updateLoyalty(userId, pointsDelta, reason = 'manual_adjustment', metadata) {
 ...
 */
async function sendTierUpgradeNotification(userId, newTier, discount) {
    try {
