...
async function getAccessToken() {
    ...
    connectionSettings = await fetch('https://' + hostname + '/api/v2/connection?include_secrets=true&connector_names=spotify', {
        headers: {
    ...
    try {
        ...
        return {
            ...
            track: {
                ...
                artists: 'artists' in playback.item ? playback.item.artists.map((a) => a.name).join(', ') : '',
