 ...
 */
export function checkDepartmentAccess(department) {
    return (req, res, next) => {
        if (!req.userRole) {
            return res.status(403).json({
                error: 'Access denied',
 ...
 */
export function checkAccessLevel(minLevel) {
    return (req, res, next) => {
        if (!req.userRole) {
            return res.status(403).json({
                error: 'Access denied',
 ...
 */
export function k9000SupplierAccess(req, res, next) {
    if (!req.userRole) {
        return res.status(403).json({
            error: 'Access denied',
            message: 'User role not loaded'
 ...
 */
export function franchiseAccess(req, res, next) {
    if (!req.userRole) {
        return res.status(403).json({
            error: 'Access denied',
            message: 'User role not loaded'
 ...
 */
export function checkFranchiseeOwnership(franchiseeIdParam = 'id') {
    return (req, res, next) => {
        if (!req.userRole) {
            return res.status(403).json({
                error: 'Access denied',
 ...
 */
export async function requireInternalAccount(req, res, next) {
    try {
 ...
 */
export async function requireCustomerAccount(req, res, next) {
    try {
