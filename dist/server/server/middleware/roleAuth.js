 ...
 */
export async function optionalEmployeeProfile(req, res, next) {
    try {
 ...
 */
export async function loadEmployeeProfile(req, res, next) {
    try {
        if (!req.firebaseUser?.uid) {
...
export function requireStationAccess(stationIdParam = 'stationId') {
    return (req, res, next) => {
        ...
        if (!req.employee.stations.includes(stationId)) {
 ...
 */
export function getEmployeePermissions(req) {
    if (!req.employee) {
        return null;
    }
