...
const ALLOW_INTENTIONAL: Array<string | RegExp> = [
  ...
  // ── COMPONENT_UNUSED cleanup candidates. 47 components with ZERO
  //    referrers in client/. Each is a wire-or-delete decision for a
  //    follow-up sweep. Added to ALLOW so the detector's baseline is
  //    clean and any NEW orphan surfaces immediately.
  /components\/AccessibilityAnnouncer\.tsx$/,
  /components\/AccessibilityButton\.tsx$/,
  /components\/AdminRouteGuard\.tsx$/,
  /components\/AppErrorBoundary\.tsx$/,
  /components\/AppleWalletButton\.tsx$/,
  /components\/AvatarCustomizer\.tsx$/,
  /components\/BackButton\.tsx$/,
  /components\/BiometricCertificateUpload\.tsx$/,
  /components\/BiometricConsentDialog\.tsx$/,
  /components\/DashboardQuickActions\.tsx$/,
  /components\/DataProcessingConsent\.tsx$/,
  /components\/EmergencyWalkBooking\.tsx$/,
  /components\/ExecutiveSuiteGuard\.tsx$/,
  /components\/FaceIDLoadingState\.tsx$/,
  /components\/GlobalContactForm\.tsx$/,
  ...
  /components\/OnboardingVerification\.tsx$/,
  /components\/PaymentPreviewCard\.tsx$/,
  /components\/ReCaptcha\.tsx$/,
  /components\/ReviewDisplay\.tsx$/,
  /components\/SpotifyPartyPlaylist\.tsx$/,
  /components\/TrackMyPet\.tsx$/,
  /components\/TransactionOTPModal\.tsx$/,
  /components\/TransactionPinModal\.tsx$/,
  /components\/VerificationStatus\.tsx$/,
  /components\/WhatsAppChat\.tsx$/,
  /components\/WorldClock\.tsx$/,
  /components\/admin\/LoyaltyDashboard\.tsx$/,
  /components\/booking\/HostStayJourney\.tsx$/,
  /components\/franchise-finance\/index\.tsx$/,
  /components\/iOSPermissionsGuide\.tsx$/,
  /components\/luxury\/LuxuryEmoji\.tsx$/,
  /components\/luxury\/LuxuryFullScreenDialog\.tsx$/,
  /components\/marketplace\/BookingRequestModal\.tsx$/,
  /components\/marketplace\/HowItWorks\.tsx$/,
  /components\/marketplace\/ServiceShowcase\.tsx$/,
  /components\/marketplace\/TrustSafetySection\.tsx$/,
  /components\/marketplace\/UnifiedSearchWidget\.tsx$/,
  /components\/weather\/BookingWeatherAlert\.tsx$/,
];
